...
INTEGER_M,INTENT(OUT) :: KULTPP(:)
INTEGER_M,INTENT(OUT) :: KPROCL(:)
INTEGER_M,INTENT(OUT) :: KPTRLS(:)
...
INTEGER_M :: IA, ILAT, ISTART, IMEDIAP,IRESTM, JA, JGL, JGLSUR, JLTLOC
LOGICAL :: LLSPLIT
...
CALL SUMPLATB(1,KDGL,KPROCA,G%NLOEN,LLSPLIT,&
