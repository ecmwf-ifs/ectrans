...
IF (LHOOK) CALL DR_HOOK('TRGOTL',0,ZHOOK_HANDLE)

IF(LBARRIER_STATS)THEN
  CALL GSTATS(761,0)
  CALL MPL_BARRIER(CDSTRING='TRGOTL:')
  CALL GSTATS(761,1)
ENDIF
...
IF (LHOOK) CALL DR_HOOK('TRGOTL',1,ZHOOK_HANDLE)
...
! note IFLD and IPOS are global variables

INTEGER(KIND=JPIM) :: IFLDT,JBLK,IFIRST,ILAST,JK,JJ,JI,JFLD
