...
!     INTEGER FUNCTIONS
INTEGER_M :: MYSENDSET,MYRECVSET,IRECVCOUNT,ISENDCOUNT
...
!....Pack loop.........................................................
    ISEND_FLD_START=1
  CALL GSTATS(1102,0)
!$OMP PARALLEL DO PRIVATE(INS,ISEND,ISETV,ISETW) &
!$OMP&            PRIVATE(IFLD,IPOS,ISENDSET,ISEND_FLD_END) &
!$OMP&            PRIVATE(JFLD,JBLK,IFIRST,ILAST,JK)
  DO INS=1,INSEND
    ISEND=JSEND(INS)
    ...
    IFLD = 0
    IPOS = 0
    CALL GTOL_PACK(INS,ISEND,ISEND_FLD_END,ISENDSET,ISETW,IFLD,IPOS)
    ZCOMBUFS(-1,INS) = 1
    ZCOMBUFS(0,INS) = IFLD
  ENDDO
!$OMP END PARALLEL DO
...
!  Unpack loop.........................................................
  CALL GSTATS(1103,0)
!$OMP PARALLEL DO PRIVATE(INR,IRECV,ILEN,IRECV_FLD_START) &
!$OMP&            PRIVATE(IRECV_FLD_END,JL,II,IPOS,JFLD)
  DO INR=1,INRECV
    IRECV=JRECV(INR)
    ILEN = IRECVTOT(IRECV)/KF_FS
    IRECV_FLD_START = ZCOMBUFR(-1,INR)
    IRECV_FLD_END   = ZCOMBUFR(0,INR)
    CALL GTOL_UNPACK(INR,IRECV,IRECV_FLD_START,IRECV_FLD_END,ILEN)
...
DO JFLD=1,KF_GP
  IF(KVSET(JFLD) == ISENDSET .OR. KVSET(JFLD) == -1 ) THEN
    ...
    IFLD = IFLD+1
    IF (IFLD >= ISEND_FLD_START(ISEND)) THEN
      DO JBLK=1,NGPBLKS
...
SUBROUTINE GTOL_UNPACK(INR,IRECV,IRECV_FLD_START,IRECV_FLD_END,ILEN)
