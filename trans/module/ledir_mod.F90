MODULE LEDIR_MOD
CONTAINS
SUBROUTINE LEDIR(KM,KFC,PAIA,PSIA,POA1,PLEPO)
...
!*       1.2      ANTISYMMETRIC PART.
  ...
  CALL MXMAOP(PLEPO(IA,ISL),2,R%NLED3,PAIA(1,ISL),NLED2,ISKIP &
      &,POA1(IA,1),2,R%NLED4*ISKIP,ILA,IDGLU,IFC)

!*       1.3      SYMMETRIC PART.

  CALL MXMAOP(PLEPO(IS,ISL),2,R%NLED3,PSIA(1,ISL),NLED2,ISKIP &
