...
INTEGER(KIND=JPIM) ,INTENT(IN) :: KF_UV,KF_SCALARS,KF_SCDERS,KF_GP,KF_FS,KF_OUT_LT
...
INTEGER(KIND=JPIM) :: J1,J2,J3,JGL,IGL,IOFF,IFGP2,IFGP3A,IFGP3B,IGP3APAR,IGP3BPAR
...
ALLOCATE(FOUBUF(D%NLENGT0B*2*KF_OUT_LT))
