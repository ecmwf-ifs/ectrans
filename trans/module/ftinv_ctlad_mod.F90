...
IF (.NOT.LSYNCSTATS) CALL GSTATS(182,0)
CALL TRGTOL(ZGTF,KF_FS,KF_GP,KF_SCALARS_G,IVSET,KPTRGP,&
 &PGP,PGPUV,PGP3A,PGP3B,PGP2)
IF (.NOT.LSYNCSTATS) CALL GSTATS(182,1)
...
IF (.NOT.LSYNCSTATS) CALL GSTATS(132,0)

IF (.NOT.LSYNCSTATS) CALL GSTATS(1641,0)
...
ENDDO
!$OMP END PARALLEL DO
IF (.NOT.LSYNCSTATS) CALL GSTATS(1641,1)
...
IF (.NOT.LSYNCSTATS) CALL GSTATS(132,1)
