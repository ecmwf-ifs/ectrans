...
INTEGER(KIND=JPIM) :: JJ,JM,JMLOC,ILATPP,IRESTL,IMLOC,IDT,INM
INTEGER(KIND=JPIM) :: JGL,IGL,IPLAT,J,ISENDSET,IRECVSET,JML,IPOS,IM
...
INTEGER(KIND=JPIM) :: IGPTOTL(NPRGPNS,NPRGPEW)
...
ALLOCATE(D%NGPTOTL(NPRGPNS,NPRGPEW))
