...
INTEGER(KIND=JPIM), INTENT(IN) :: KF_UV_G,KF_SCALARS_G,KF_GP,KF_FS,KF_OUT_LT
...
INTEGER(KIND=JPIM) :: IBLKS,J,JBLK,ISTF,IENF,IFLDS,ISTUV_G,IENUV_G
INTEGER(KIND=JPIM) :: IF_UV_G,IF_UV,ISTUV,IF_SCALARS,IF_SCALARS_G,IF_FS,IF_GP
INTEGER(KIND=JPIM) :: IFLDSUV,JFLD,ISTSC_G,IENSC_G,ISTSC,IENSC,IENUV,IF_SCDERS,IF_OUT_LT
