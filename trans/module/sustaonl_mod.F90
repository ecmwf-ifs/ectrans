...
INTEGER(KIND=JPIM) :: KMEDIAP
INTEGER(KIND=JPIM) :: KRESTM


INTEGER(KIND=JPIM) :: IXPTLAT(R%NDGL), ILSTPTLAT(R%NDGL), INTOTRE(NPRGPEW)
INTEGER(KIND=JPIM) :: ICHK(R%NDLON,R%NDGL), ICOMBUF(R%NDGL*NPRGPEW*2)

!     LOCAL INTEGER SCALARS
INTEGER(KIND=JPIM) :: I1, I2, IB, IBS, IBUFLEN, IDGLG, IDWIDE,&
