...
!  Send/Recv loop.........................................................
  ...
  IF (.NOT.LSYNCSTATS) CALL GSTATS(696,0)
  ...
  IF (.NOT.LSYNCSTATS) CALL GSTATS(696,1)
...
! For MYPROC copy straight accross
  ...
  IF (.NOT.LSYNCSTATS) CALL GSTATS(1608,0)
!$OMP PARALLEL DO SCHEDULE(STATIC) PRIVATE(J)
  DO J=ISTA,ISTA+ILEN-1
    PFBUF(J) = PFBUF_IN(J)
  ENDDO
!$OMP END PARALLEL DO
  IF (.NOT.LSYNCSTATS) CALL GSTATS(1608,1)
...
! completed communication
  ...
  IF( NPRTRW > 1 )THEN
    IF (.NOT.LSYNCSTATS) CALL GSTATS(734,0)
    CALL MPL_BARRIER(CDSTRING='TRMTOL:')
    IF (.NOT.LSYNCSTATS) CALL GSTATS(734,1)
  ENDIF
ENDIF
