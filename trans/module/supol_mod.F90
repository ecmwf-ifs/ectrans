...
INTEGER(KIND=JPIM) :: KNSMAX

REAL(KIND=JPRH) :: DDMU,DDPOL(0:KNSMAX,0:KNSMAX)
REAL(KIND=JPRH) :: DLX,DLSITA,DL1SITA,DLKM2,DLKM1,DLK,DL1,DLS
REAL(KIND=JPRH) :: DDC(0:KNSMAX,0:KNSMAX)
REAL(KIND=JPRH) :: DDD(0:KNSMAX,0:KNSMAX)
REAL(KIND=JPRH) :: DDE(0:KNSMAX,0:KNSMAX)
REAL(KIND=JPRH) :: DDA(0:KNSMAX),DDB(0:KNSMAX),DDF(0:KNSMAX)
REAL(KIND=JPRH) :: DDG(0:KNSMAX),DDH(0:KNSMAX),DDI(0:KNSMAX)
