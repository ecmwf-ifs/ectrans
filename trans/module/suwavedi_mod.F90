...
INTEGER(KIND=JPIM) :: KMYSETA
INTEGER(KIND=JPIM) :: KPROCA
INTEGER(KIND=JPIM) :: KSMAX
INTEGER(KIND=JPIM) :: KSPEC
INTEGER(KIND=JPIM) :: KSPEC2
INTEGER(KIND=JPIM) :: KSPEC2MX
INTEGER(KIND=JPIM) :: KSPOLEGL
INTEGER(KIND=JPIM) :: KTMAX



INTEGER(KIND=JPIM) :: KASM0(0:KSMAX), KPROCM(0:KSMAX), KUMPP(KPROCA)
INTEGER(KIND=JPIM) :: KMYMS(KSMAX+1), KPOSSP(KPROCA+1)
