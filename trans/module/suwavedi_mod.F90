...
INTEGER(KIND=JPIM),INTENT(OUT) :: KSPEC
INTEGER(KIND=JPIM),INTENT(OUT) :: KSPEC2
INTEGER(KIND=JPIM),INTENT(OUT) :: KSPEC2MX
INTEGER(KIND=JPIM),INTENT(OUT) :: KSPOLEGL

INTEGER(KIND=JPIM),INTENT(OUT) :: KASM0(0:KSMAX)
INTEGER(KIND=JPIM),INTENT(OUT) :: KPROCM(0:KSMAX)
INTEGER(KIND=JPIM),INTENT(OUT) :: KUMPP(KPROCA)
INTEGER(KIND=JPIM),INTENT(OUT) :: KMYMS(KSMAX+1)
INTEGER(KIND=JPIM),INTENT(OUT) :: KPOSSP(KPROCA+1)

!     LOCAL 
INTEGER(KIND=JPIM) :: IK, IL, IND, IPOS, ISPEC2P, JA, JM
INTEGER(KIND=JPIM) :: ISPEC(KPROCA)
