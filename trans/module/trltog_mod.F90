...
!     INTEGER FUNCTIONS
INTEGER_M :: ISENDCOUNT,IRECVCOUNT,J
...
!...Send loop.........................................................
  ...
  IF (.NOT.LSYNCSTATS) CALL GSTATS(693,0)
  DO INS=1,INSEND
    ISEND=JSEND(INS)
  ...
  ENDDO
  IF (.NOT.LSYNCSTATS) CALL GSTATS(693,1)

!...Receive loop.........................................................

  IF (.NOT.LSYNCSTATS) CALL GSTATS(694,0)
  DO INR=1,INRECV
    IRECV=JRECV(INR)
  ...
  ENDIF
  IF (.NOT.LSYNCSTATS) CALL GSTATS(694,1)
...
! completed communication
  ...
  IF( NPROC > 1 .AND. (D%LSPLIT .OR. NPRTRV > 1 .OR. NPRGPEW > 1 ))THEN
    IF (.NOT.LSYNCSTATS) CALL GSTATS(732,0)
    CALL MPL_BARRIER(CDSTRING='TRLTOG:')
    IF (.NOT.LSYNCSTATS) CALL GSTATS(732,1)
  ENDIF
ENDIF
