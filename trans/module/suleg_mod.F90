...
IF (.NOT.LSYNCSTATS) CALL GSTATS(140,0)
...
IF (.NOT.LSYNCSTATS) CALL GSTATS(1801,0)
DO JNM=1,D%NSPOLEGL
  F%RPNM(R%NLEI3,JNM) = 0.0_JPRB
ENDDO
IF (.NOT.LSYNCSTATS) CALL GSTATS(1801,1)
...
ENDDO
IF (.NOT.LSYNCSTATS) CALL GSTATS(1801,1)
IF (.NOT.LSYNCSTATS) CALL GSTATS(140,1)

IF (.NOT.LSYNCSTATS) CALL GSTATS(190,0)
CALL SUTRLE(ZPNMG)
IF (.NOT.LSYNCSTATS) CALL GSTATS(190,1)
