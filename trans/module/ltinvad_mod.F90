...
CALL ASRE1AD(KM,KMLOC,KF_OUT_LT,ZAOA1,ZSOA1)
...
CALL LEINVAD(KM,IFC,KF_OUT_LT,ZIA(:,ISTA:ISTA+IFC-1),ZAOA1,ZSOA1,ZLEPO)
...
CALL PRFI1AD(KM,KF_UV,KF_SCALARS,ZIA,PSPVOR,PSPDIV,PSPSCALAR,&
 & KFLDPTRUV,KFLDPTRSC)
