...
INTEGER_M,INTENT(IN)  :: KBLK,KF_GP,KKF_UV_G
INTEGER_M, INTENT(IN)  :: KVSETUV(:),KVSETSC(:)
INTEGER_M, INTENT(OUT) :: KSTUV_G,KENUV_G,KF_UV_G,KSTSC_G,KENSC_G,KF_SCALARS_G
INTEGER_M, INTENT(OUT) :: KSTUV,KENUV,KF_UV,KSTSC,KENSC,KF_SCALARS

! Local variables

INTEGER_M :: ISTF,IENF,J
