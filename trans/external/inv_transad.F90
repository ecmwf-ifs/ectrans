...
IF (IF_UV > 0) THEN
  IF(.NOT. PRESENT(PSPVOR) ) THEN
    CALL ABOR1("INV_TRANSAD : IF_UV > 0 BUT PSPVOR MISSING")
  ENDIF
  ...
  IF(.NOT. PRESENT(PSPDIV) ) THEN
    CALL ABOR1("INV_TRANSAD : IF_UV > 0 BUT PSPDIV MISSING")
  ENDIF
...
IF (IF_SCALARS > 0) THEN
  IF(.NOT. PRESENT(PSPSCALAR) ) THEN
    CALL ABOR1('INV_TRANSAD : IF_SCALARS > 0 BUT PSPSCALAR MISSING')
  ENDIF
