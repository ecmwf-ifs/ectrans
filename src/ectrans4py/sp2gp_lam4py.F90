...
REAL(KIND=JPRB), DIMENSION(KSIZE), INTENT(IN) :: PSPEC
REAL(KIND=JPRB), DIMENSION(KSIZEI*KSIZEJ), INTENT(OUT) :: PGPT
REAL(KIND=JPRB), DIMENSION(KSIZEI*KSIZEJ), INTENT(OUT) :: PGPTM
REAL(KIND=JPRB), DIMENSION(KSIZEI*KSIZEJ), INTENT(OUT) :: PGPTL
!
...
REAL(KIND=JPRB), DIMENSION(1, KSIZE) :: ZSPBUF
