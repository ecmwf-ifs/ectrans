...
REAL(KIND=JPRB), DIMENSION(KGPTOT), INTENT(OUT) :: PGPT
REAL(KIND=JPRB), DIMENSION(KGPTOT), INTENT(OUT) :: PGPTM
REAL(KIND=JPRB), DIMENSION(KGPTOT), INTENT(OUT) :: PGPTL
!
