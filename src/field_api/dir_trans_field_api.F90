...
USE ECTRANS_FIELD_VIEW_MOD, ONLY: FIELD_VIEW, FIELD_TYPE_GP_U, FIELD_TYPE_GP_V, FIELD_TYPE_GP_S, &
                                & FIELD_TYPE_SP_VOR, FIELD_TYPE_SP_DIV, FIELD_TYPE_SP_S
...
DO IFIELD=1,NFIELD_UV
  CALL MAKE_FIELD_VIEW(YLFVGU(IFIELD),   YDFU(IFIELD),     FIELD_TYPE_GP_U,   LDACC=.FALSE., LDRDONLY=.TRUE.)
  CALL MAKE_FIELD_VIEW(YLFVGV(IFIELD),   YDFV(IFIELD),     FIELD_TYPE_GP_V,   LDACC=.FALSE., LDRDONLY=.TRUE.)
  CALL MAKE_FIELD_VIEW(YLFVSVOR(IFIELD), YDFSPVOR(IFIELD), FIELD_TYPE_SP_VOR, LDACC=.FALSE., LDRDONLY=.TRUE.)
  CALL MAKE_FIELD_VIEW(YLFVSDIV(IFIELD), YDFSPDIV(IFIELD), FIELD_TYPE_SP_DIV, LDACC=.FALSE., LDRDONLY=.TRUE.)
ENDDO
DO IFIELD=1,NFIELD_SCALAR
  CALL MAKE_FIELD_VIEW(YLFVGSCALAR(IFIELD), YDFSCALAR(IFIELD),   FIELD_TYPE_GP_S, LDACC=.FALSE., LDRDONLY=.FALSE.)
  CALL MAKE_FIELD_VIEW(YLFVSSCALAR(IFIELD), YDFSPSCALAR(IFIELD), FIELD_TYPE_SP_S, LDACC=.FALSE., LDRDONLY=.FALSE.)
ENDDO

CALL DIR_TRANS_FIELD_VIEW(YLFVGSCALAR, YLFVGU, YLFVGV, YLFVSSCALAR, YLFVSVOR, YLFVSDIV, KRESOL)
RETURN
END BLOCK
ENDIF
