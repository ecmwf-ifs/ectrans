...
DO IFIELD=1,NFIELD_UV
  CALL MAKE_FIELD_VIEW(YLFVGU(IFIELD),   YDFU(IFIELD),     LDACC=LDACC, LDRDONLY=.FALSE.)
  CALL MAKE_FIELD_VIEW(YLFVGV(IFIELD),   YDFV(IFIELD),     LDACC=LDACC, LDRDONLY=.FALSE.)
  CALL MAKE_FIELD_VIEW(YLFVSVOR(IFIELD), YDFSPVOR(IFIELD), LDACC=LDACC, LDRDONLY=.TRUE.)
  CALL MAKE_FIELD_VIEW(YLFVSDIV(IFIELD), YDFSPDIV(IFIELD), LDACC=LDACC, LDRDONLY=.TRUE.)
ENDDO

DO IFIELD=1,NFIELD_UVDER
  CALL MAKE_FIELD_VIEW(YLFVGU_EW(IFIELD), YDFU_EW(IFIELD), LDACC=LDACC, LDRDONLY=.FALSE.)
  CALL MAKE_FIELD_VIEW(YLFVGV_EW(IFIELD), YDFV_EW(IFIELD), LDACC=LDACC, LDRDONLY=.FALSE.)
ENDDO

DO IFIELD=1,NFIELD_DIVGP
  CALL MAKE_FIELD_VIEW(YLFVGDIV(IFIELD), YDFDIV(IFIELD), LDACC=LDACC, LDRDONLY=.FALSE.)
ENDDO

DO IFIELD=1,NFIELD_VORGP
  CALL MAKE_FIELD_VIEW(YLFVGVOR(IFIELD), YDFVOR(IFIELD), LDACC=LDACC, LDRDONLY=.FALSE.)
ENDDO

DO IFIELD=1,NFIELD_SCALAR
  CALL MAKE_FIELD_VIEW(YLFVGSCALAR(IFIELD), YDFSCALAR(IFIELD),   LDACC=LDACC, LDRDONLY=.FALSE.)
  CALL MAKE_FIELD_VIEW(YLFVSSCALAR(IFIELD), YDFSPSCALAR(IFIELD), LDACC=LDACC, LDRDONLY=.TRUE.)
ENDDO

DO IFIELD=1,NFIELD_SCDER
  CALL MAKE_FIELD_VIEW(YLFVGSCALAR_NS(IFIELD), YDFSCALAR_NS(IFIELD), LDACC=LDACC, LDRDONLY=.FALSE.)
  CALL MAKE_FIELD_VIEW(YLFVGSCALAR_EW(IFIELD), YDFSCALAR_EW(IFIELD), LDACC=LDACC, LDRDONLY=.FALSE.)
ENDDO
