...
#if PRECOPT == 1
USE ECTRANS_MOD_SP, ONLY : TRANS_INQ_SP => TRANS_INQ
#elif PRECOPT == 2
USE ECTRANS_MOD_DP, ONLY : TRANS_INQ_DP => TRANS_INQ
#endif
...
IF(JPRB == JPRM) THEN
#if PRECOPT == 1
CALL TRANS_INQ_SP(KRESOL,KSPEC,KSPEC2,KSPEC2G,KSPEC2MX,KNUMP,&
                    &KGPTOT,KGPTOTG,KGPTOTMX,KGPTOTL,&
                    &KMYMS,KASM0,KUMPP,KPOSSP,KPTRMS,KALLMS,KDIM0G,&
                    &KFRSTLAT,KLSTLAT,KFRSTLOFF,KPTRLAT,&
                    &KPTRFRSTLAT,KPTRLSTLAT,KPTRFLOFF,KSTA,KONL,&
...
#if PRECOPT == 2
CALL TRANS_INQ_DP(KRESOL,KSPEC,KSPEC2,KSPEC2G,KSPEC2MX,KNUMP,&
                    &KGPTOT,KGPTOTG,KGPTOTMX,KGPTOTL,&
                    &KMYMS,KASM0,KUMPP,KPOSSP,KPTRMS,KALLMS,KDIM0G,&
                    &KFRSTLAT,KLSTLAT,KFRSTLOFF,KPTRLAT,&
                    &KPTRFRSTLAT,KPTRLSTLAT,KPTRFLOFF,KSTA,KONL,&
