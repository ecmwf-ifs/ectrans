...
SUBROUTINE SETUP_TRANS0_ISP(KOUT,KERR,KPRINTLEV,KMAX_RESOL,KPROMATR,&
...
USE ECTRANS_MOD_SP, ONLY : SETUP_TRANS0 
...
REAL(KIND=JPRM)    ,OPTIONAL,INTENT(IN)  :: PRAD
...
CALL SETUP_TRANS0(KOUT,KERR,KPRINTLEV,KMAX_RESOL,KPROMATR,&
&                       KPRGPNS,KPRGPEW,KPRTRW,KCOMBFLEN,&
&                       LDMPOFF,LDSYNC_TRANS,KTRANS_SYNC_LEVEL,&
&                       LDEQ_REGIONS,K_REGIONS_NS,K_REGIONS_EW,K_REGIONS,&
&                       PRAD,LDALLOPERM)

END SUBROUTINE SETUP_TRANS0_ISP

SUBROUTINE SETUP_TRANS0_IDP(KOUT,KERR,KPRINTLEV,KMAX_RESOL,KPROMATR,&
&                       KPRGPNS,KPRGPEW,KPRTRW,KCOMBFLEN,&
&                       LDMPOFF,LDSYNC_TRANS,KTRANS_SYNC_LEVEL,&
&                       LDEQ_REGIONS,K_REGIONS_NS,K_REGIONS_EW,K_REGIONS,&
&                       PRAD,LDALLOPERM, PRECBACKEND_FLAG)
USE EC_PARKIND  ,ONLY : JPIM, JPRD
USE ECTRANS_MOD_DP, ONLY : SETUP_TRANS0 
...
END SUBROUTINE SETUP_TRANS0_IDP
