...
!   Optional device-residency hint for `PGP`, `PGPUV`, `PGP3A`, `PGP3B` and `PGP2`. If present and  
!   true, the GPU path assumes the corresponding present array is already resident on device and  
!   skips the associated host/device synchronization. Ignored on the CPU path.  
!   *Default*: `.FALSE.`
!
