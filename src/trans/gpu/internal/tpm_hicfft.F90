...
MODULE TPM_HICFFT
  ...
  PRIVATE
  PUBLIC PREPLAN_DIR_FFT, PREPLAN_INV_FFT
  PUBLIC EXECUTE_DIR_FFT, EXECUTE_INV_FFT
  PUBLIC CLEAN_FFT

INTERFACE PREPLAN_DIR_FFT
  MODULE PROCEDURE PREPLAN_DIR_FFT_FLOAT, PREPLAN_DIR_FFT_DOUBLE
END INTERFACE

INTERFACE PREPLAN_INV_FFT
  MODULE PROCEDURE PREPLAN_INV_FFT_FLOAT, PREPLAN_INV_FFT_DOUBLE
END INTERFACE
...
SUBROUTINE PREPLAN_DIR_FFT_FLOAT(KFIELD,RESOL_ID,LOENS,OFFSETS,REAL_DUMMY)
  ...
  REAL(KIND=C_FLOAT),INTENT(IN) :: REAL_DUMMY
  INTERFACE
    SUBROUTINE PREPLAN_DIR_FFT_FLOAT_C(KFIELD,RESOL_ID,LOENS,OFFSETS,NFFT) &
 &                   BIND(C, NAME="preplan_dir_fft_float")
  ...
  CALL PREPLAN_DIR_FFT_FLOAT_C(KFIELD,RESOL_ID,LOENS,OFFSETS,SIZE(LOENS))

END SUBROUTINE PREPLAN_DIR_FFT_FLOAT

SUBROUTINE PREPLAN_INV_FFT_FLOAT(KFIELD,RESOL_ID,LOENS,OFFSETS,REAL_DUMMY)
  USE EC_PARKIND ,ONLY : JPIM, JPIB
  ...
  REAL(KIND=C_FLOAT),INTENT(IN) :: REAL_DUMMY
  INTERFACE
    SUBROUTINE PREPLAN_INV_FFT_FLOAT_C(KFIELD,RESOL_ID,LOENS,OFFSETS,NFFT) &
 &                   BIND(C, NAME="preplan_inv_fft_float")
      USE ISO_C_BINDING, ONLY: C_INT, C_INT64_T
      INTEGER(KIND=C_INT),INTENT(IN),VALUE  :: KFIELD
      INTEGER(KIND=C_INT),INTENT(IN),VALUE  :: RESOL_ID
      INTEGER(KIND=C_INT),INTENT(IN)  :: LOENS(*)
  ...
  CALL PREPLAN_INV_FFT_FLOAT_C(KFIELD,RESOL_ID,LOENS,OFFSETS,SIZE(LOENS))

END SUBROUTINE PREPLAN_INV_FFT_FLOAT

SUBROUTINE PREPLAN_DIR_FFT_DOUBLE(KFIELD,RESOL_ID,LOENS,OFFSETS,REAL_DUMMY)
  USE EC_PARKIND ,ONLY : JPIM, JPIB
  ...
  INTEGER(KIND=JPIM),INTENT(IN) :: LOENS(:)
  INTEGER(KIND=JPIB),INTENT(IN) :: OFFSETS(:)
  REAL(KIND=C_DOUBLE),INTENT(IN) :: REAL_DUMMY
  INTERFACE
    SUBROUTINE PREPLAN_DIR_FFT_DOUBLE_C(KFIELD,RESOL_ID,LOENS,OFFSETS,NFFT) &
 &                   BIND(C, NAME="preplan_dir_fft_double")
      USE ISO_C_BINDING, ONLY: C_INT, C_INT64_T
      INTEGER(KIND=C_INT),INTENT(IN),VALUE  :: KFIELD
      INTEGER(KIND=C_INT),INTENT(IN),VALUE  :: RESOL_ID
      INTEGER(KIND=C_INT),INTENT(IN)  :: LOENS(*)
  ...
  CALL PREPLAN_DIR_FFT_DOUBLE_C(KFIELD,RESOL_ID,LOENS,OFFSETS,SIZE(LOENS))

END SUBROUTINE PREPLAN_DIR_FFT_DOUBLE

SUBROUTINE PREPLAN_INV_FFT_DOUBLE(KFIELD,RESOL_ID,LOENS,OFFSETS,REAL_DUMMY)
  USE EC_PARKIND ,ONLY : JPIM, JPIB
  ...
  REAL(KIND=C_DOUBLE),INTENT(IN) :: REAL_DUMMY
  INTERFACE
    SUBROUTINE PREPLAN_INV_FFT_DOUBLE_C(KFIELD,RESOL_ID,LOENS,OFFSETS,NFFT) &
 &                   BIND(C, NAME="preplan_inv_fft_double")
      USE ISO_C_BINDING, ONLY: C_INT, C_INT64_T
      INTEGER(KIND=C_INT),INTENT(IN),VALUE  :: KFIELD
      INTEGER(KIND=C_INT),INTENT(IN),VALUE  :: RESOL_ID
      INTEGER(KIND=C_INT),INTENT(IN)  :: LOENS(*)
  ...
  CALL PREPLAN_INV_FFT_DOUBLE_C(KFIELD,RESOL_ID,LOENS,OFFSETS,SIZE(LOENS))

END SUBROUTINE PREPLAN_INV_FFT_DOUBLE
