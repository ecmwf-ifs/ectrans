...
CONTAINS
  SUBROUTINE DIR_TRANS_CTLAD(KF_UV_G,KF_SCALARS_G,KF_GP,KF_FS,KF_UV,KF_SCALARS,&
    ...
    IF (KF_FS > 0) THEN
      CALL LTDIRAD(ALLOCATOR,HLTDIR,ZINPS,ZINPA,KF_FS,KF_UV,KF_SCALARS, &
                 & PSPVOR,PSPDIV,PSPSCALAR,&
                 & PSPSC3A,PSPSC3B,PSPSC2)

      CALL GSTATS(153,0)
      CALL TRLTOMAD_UNPACK(ALLOCATOR,HTRLTOM_UNPACK,FOUBUF,ZINPS,ZINPA,KF_FS,KF_UV)
      ! Adjoint version of TRLTOM is equivalent to normal version of TRMTOL
