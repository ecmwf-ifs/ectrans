...
CALL GSTATS_LABEL(410,'   ','MPI - TRMTOL')
CALL GSTATS_LABEL(411,'   ','MPI - TRLTOM')
CALL GSTATS_LABEL(412,'   ','MPI - TRLTOG')
CALL GSTATS_LABEL(413,'   ','MPI - TRGTOL')
CALL GSTATS_LABEL(420,'   ','TRLTOM Barrier')
CALL GSTATS_LABEL(421,'   ','TRMTOL Barrier')
CALL GSTATS_LABEL(422,'   ','TRLTOG Barrier')
CALL GSTATS_LABEL(423,'   ','TRGTOL Barrier')
