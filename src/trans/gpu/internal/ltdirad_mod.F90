...
#endif
#ifdef OMPGPU
    !$OMP TARGET DATA MAP(ECTRANS_MAP_PRESENT_ALLOC:POA1,R_NTMAX,D_NUMP)
    !$OMP TARGET TEAMS DISTRIBUTE PARALLEL DO COLLAPSE(3) DEFAULT(ECTRANS_OMP_DEFAULT) SHARED(R,D,KF_FS,POA1) &
    !$OMP& MAP(TO:KF_FS)
#endif
    DO KMLOC=1,D_NUMP
        DO JN=1,R_NTMAX+3
