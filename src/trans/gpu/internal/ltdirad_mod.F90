...
MODULE LTDIRAD_MOD
  USE PARKIND_ECTRANS,        ONLY: JPIM, JPRBT, JPRB, JPIB
...
CONTAINS
  ...
  SUBROUTINE LTDIRAD(ALLOCATOR,HLTDIR,ZINPS,ZINPA,KF_FS,KF_UV,KF_SCALARS,&
    ...
    INTEGER(KIND=JPIB)  :: IOUT_STRIDES0, IOUT_SIZE
    INTEGER(KIND=JPIB)  :: IIN_STRIDES0, IIN_SIZE
    ...
    CALL LEINV(ALLOCATOR,POA1,ZOUT,ZINPS,ZINPA,KF_FS)
