...
MODULE TRLTOMAD_PACK_UNPACK
  ...
  PRIVATE
  PUBLIC :: TRLTOMAD_PACK
  PUBLIC :: TRLTOMAD_UNPACK

CONTAINS
  SUBROUTINE TRLTOMAD_PACK(ALLOCATOR,HTRMTOL_UNPACK,PREEL_COMPLEX,FOUBUF_IN,KF_FS)
    ...
    USE TRMTOL_PACK_UNPACK,     ONLY: TRMTOL_UNPACK_HANDLE
    !
  ...
  SUBROUTINE TRLTOMAD_UNPACK(ALLOCATOR,HTRMTOL_PACK,FOUBUF,ZINPS,ZINPA,ZINPS0,ZINPA0,KF_FS,KF_UV)
    ...
    USE TRMTOL_PACK_UNPACK,          ONLY: TRMTOL_PACK_HANDLE
    ...
    CALL ASSIGN_PTR(FOUBUF, GET_ALLOCATION(ALLOCATOR, HTRMTOL_PACK%HFOUBUF_IN),&
