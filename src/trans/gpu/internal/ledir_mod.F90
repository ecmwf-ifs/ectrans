...
REAL(KIND=JPRD), POINTER :: ZBASE0(:), ZINP0(:), ZOUT0(:)
...
ALLOC_POS=1
CALL C_F_POINTER(C_LOC(PREEL_PTR(ALLOC_POS:)), ZBASE, &
    & [SIZEOF(PREEL_PTR(ALLOC_POS:))/SIZEOF(ZBASE(0))])
...
CALL C_F_POINTER(C_LOC(PREEL_PTR(ALLOC_POS:)), ZBASE0, &
    & [SIZEOF(PREEL_PTR(ALLOC_POS:))/SIZEOF(ZBASE0(0))])
ALLOC_POS=1
