...
!$OMP&     SHARED(D_NUMP,R_NDGNH,KFC,D_MYMS,G_NDGLU,DZBST,DLDZBA,DTDZBA,PAIA,F)
#endif
#ifdef ACCGPU
!$ACC PARALLEL LOOP COLLAPSE(3) PRIVATE(KM,KDGLU,ISL,ISKIP) DEFAULT(NONE) &
!$ACC&     PRESENT(D_NUMP,R_NDGNH,KFC,D_MYMS,G_NDGLU,DZBST,DLDZBA,DTDZBA,PAIA,F)
#endif
DO KMLOC=1,D_NUMP
   DO J=1,R_NDGNH   
      DO JK=1,KFC
...
!$ACC&    PRESENT(D_NUMP,R_NTMAX,KFC,D_MYMS,POA1,DZCAT,DLDZCA,DTDZCA)
#endif
DO KMLOC=1,D_NUMP
   DO J=1,(R_NTMAX+2)/2
      DO JK=1,KFC
...
IF(KMLOC0 > 0) THEN
  ...
  !$OMP&     SHARED(R_NDGNH,KFC,G_NDGLU,DZBST0,DTDZBA,PAIA,KMLOC0,F,ISKIP)
#endif
#ifdef ACCGPU
  !$ACC PARALLEL LOOP COLLAPSE(2) PRIVATE(KDGLU,ISL) DEFAULT(NONE) &
  !$ACC&     PRESENT(R_NDGNH,KFC,G_NDGLU,DZBST0,DTDZBA,PAIA,KMLOC0,F,ISKIP)
#endif
   DO J=1,R_NDGNH
    DO JK=1,KFC
  ...
  !$ACC END HOST_DATA
   ...
   !$ACC&    PRESENT(R_NTMAX,KFC,POA1,DZCAT0,DTDZCA,KMLOC0,ISKIP)
#endif
   DO J=1,(R_NTMAX+2)/2
   DO JK=1,KFC
         IF (MOD((JK-1),ISKIP) .EQ. 0) THEN
...
#ifdef OMPGPU
!$OMP TARGET PARALLEL DO COLLAPSE(3) PRIVATE(KM,KDGLU,ISL,ISKIP) DEFAULT(NONE) &
!$OMP&     SHARED(D_NUMP,R_NDGNH,KFC,D_MYMS,G_NDGLU,DZBST,DLDZBS,DTDZBS,PAIA,F)
#endif
#ifdef ACCGPU
!$ACC PARALLEL LOOP COLLAPSE(3) PRIVATE(KM,KDGLU,ISL,ISKIP) DEFAULT(NONE) &
!$ACC &    PRESENT(D_NUMP,R_NDGNH,KFC,D_MYMS,G_NDGLU,DZBST,DLDZBS,DTDZBS,PAIA,F)
#endif
DO KMLOC=1,D_NUMP
   DO J=1,R_NDGNH   
      DO JK=1,KFC
...
!$ACC&    PRESENT(D_NUMP,R_NTMAX,KFC,D_MYMS,POA1,DZCST,DLDZCS,DTDZCS)
#endif
  DO KMLOC=1,D_NUMP
   DO J=1,(R_NTMAX+3)/2
      DO JK=1,KFC
...
IF(KMLOC0 > 0) THEN
...
#ifdef OMPGPU
   !$OMP TARGET PARALLEL DO COLLAPSE(3) PRIVATE(KDGLU,ISL) DEFAULT(NONE) &
   !$OMP&     SHARED(R_NDGNH,KFC,G_NDGLU,DZBST0,DTDZBS,PAIA,KMLOC0,F,ISKIP)
#endif
#ifdef ACCGPU
   !$ACC PARALLEL LOOP COLLAPSE(2) PRIVATE(KDGLU,ISL) DEFAULT(NONE) &
   !$ACC&     PRESENT(R_NDGNH,KFC,G_NDGLU,DZBST0,DTDZBS,PAIA,KMLOC0,F,ISKIP)
#endif
   DO J=1,R_NDGNH   
      DO JK=1,KFC
         KDGLU = MIN(R_NDGNH,G_NDGLU(0))
 ...
 &                            0._JPRD,DZCST0,DTDZCS,DLDZCS,1)
   ...
   !$ACC&    PRESENT(R_NTMAX,KFC,POA1,DZCST0,DTDZCS,KMLOC0,ISKIP)
#endif
   DO J=1,(R_NTMAX+3)/2
      DO JK=1,KFC
         IF (MOD((JK-1),ISKIP) .EQ. 0) THEN
