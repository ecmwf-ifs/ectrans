...
IOUT_STRIDES0 = 2*KF_FS
IOUT_STRIDES1 = IOUT_STRIDES0 * MAX((R%NTMAX+2)/2,(R%NTMAX+3)/2)
IIN_STRIDES0 = 2*KF_FS
IIN_STRIDES1 = IIN_STRIDES0 * R_NDGNH
IOUT0_STRIDES0 = KF_FS
IOUT0_STRIDES1 = IOUT0_STRIDES0 * MAX((R%NTMAX+2)/2,(R%NTMAX+3)/2)
IIN0_STRIDES0 = KF_FS
IIN0_STRIDES1 = IIN0_STRIDES0 * R_NDGNH
