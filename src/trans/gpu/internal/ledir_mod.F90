...
FUNCTION PREPARE_LEDIR_UNPACK(ALLOCATOR, KF_FS) RESULT(HLEDIR_UNPACK)
  ...
  ISIZE = ALIGN(IIN_STRIDES1*D%NUMP*SIZEOF(ZPRBT_DUMMY),128)
  ISIZE = ISIZE + ALIGN(IIN_STRIDES1*D%NUMP*SIZEOF(ZPRBT_DUMMY),128)
  ISIZE = ISIZE + ALIGN(IIN0_STRIDES1*SIZEOF(ZPRD_DUMMY),128)
  ISIZE = ISIZE + ALIGN(IIN0_STRIDES1*SIZEOF(ZPRD_DUMMY),128)

  HLEDIR_UNPACK%ZINPS_AND_ZINPA = RESERVE(ALLOCATOR, ISIZE)
