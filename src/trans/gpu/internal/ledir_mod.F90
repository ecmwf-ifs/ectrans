...
!$ACC& PRESENT(D_NPNTGTB1,D_NSTAGT1B,D_NPROCL) &
...
!$ACC PARALLEL LOOP DEFAULT(NONE) COLLAPSE(3) PRIVATE(KM,ISL,IGLS,OFFSET1,OFFSET2,JGL,PAIA,PAIS) FIRSTPRIVATE(KF_FS,KF_UV)
#endif
DO KMLOC=1,D_NUMP
  DO JGL=1,R_NDGNH
    DO JF=1,KF_FS*2
