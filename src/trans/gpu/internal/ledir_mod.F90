...
MODULE LEDIR_MOD
  ...
  PRIVATE
  PUBLIC :: LEDIR, LEDIR_ALLOC_SIZE, LEDIR_PACK_BUFFER, LEDIR_POINTERS
...
SUBROUTINE LEDIR_PACK_BUFFER(FOUBUF,ZINPS,ZINPA,ZINPS0,ZINPA0,KF_FS,KF_UV)
  USE PARKIND_ECTRANS  ,ONLY : JPIM, JPRBT, JPRD
  ...
  !$ACC END DATA
#endif
END SUBROUTINE LEDIR_PACK_BUFFER
