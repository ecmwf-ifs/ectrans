...
CONTAINS
  ...
  SUBROUTINE TRLTOM_PACK(ALLOCATOR,HTRLTOM_PACK,PREEL_COMPLEX,FOUBUF_IN,KF_FS)
   ...
   !$OMP& D_NDGL_FS,G_NLOEN,R_NSMAX)
    ...
    !$OMP& ECTRANS_DEVICE_ADDR_CLAUSE(PREEL_COMPLEX,FOUBUF_IN) &
    !$OMP& SHARED(KF_FS,OFFSET_VAR) MAP(TO:KF_FS,OFFSET_VAR)
#endif
#ifdef ACCGPU
  ...
  SUBROUTINE TRLTOM_UNPACK(ALLOCATOR,HTRLTOM_UNPACK,FOUBUF,ZINPS,ZINPA,ZINPS0,ZINPA0,KF_FS,KF_UV)
    ...
    !$OMP& SHARED(KF_FS,IIN_STRIDES0,IIN0_STRIDES0,KF_UV) &
    ...
    !$OMP& SHARED(KF_FS,IIN_STRIDES0) MAP(TO:KF_FS)
#endif
#ifdef ACCGPU
