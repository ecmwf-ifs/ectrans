...
USE PARKIND_ECTRANS  ,ONLY : JPIM, JPIB, JPRB, JPRBT, JPRD, JPRL
...
INTEGER(KIND=JPIB) :: TDZAA
INTEGER(KIND=JPIB) :: TDZAS

INTEGER(KIND=JPIB) :: ILDZBA
INTEGER(KIND=JPIB) :: ILDZBS
INTEGER(KIND=JPIB) :: ILDZCA
INTEGER(KIND=JPIB) :: ILDZCS



INTEGER(KIND=JPIB) :: DLDZBA
INTEGER(KIND=JPIB) :: DLDZBS
INTEGER(KIND=JPIB) :: DLDZCA
INTEGER(KIND=JPIB) :: DLDZCS
