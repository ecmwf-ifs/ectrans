...
!$ACC&    FIRSTPRIVATE(KFIELDS,TDZAA)
#endif
DO KMLOC=1,D_NUMP
  DO JK=1,KFIELDS
    KM =  D_MYMS(KMLOC)
...
IF (KMLOC0 > 0) THEN
  ...
  !$ACC& FIRSTPRIVATE(KFIELDS,KMLOC0)
#endif
  DO J=1,(R_NSMAX+2)/2
    DO JK=1,KFIELDS,2
  ...
  CALL HIP_DGEMM_BATCHED( &
    ...
    & 1.0_JPRD, &
    & ZINP0, KFIELDS/2, TDZAA, &
    & ZAA0, R_NDGNH, TDZAA, &
    & 0.0_JPRD, &
    & ZOUT0, KFIELDS/2, R_NDGNH, &
    & 1)
#ifdef ACCGPU
  !$ACC END HOST_DATA
#endif
...
!$ACC&    FIRSTPRIVATE(KFIELDS,TDZAS)
#endif
DO KMLOC=1,D_NUMP
  DO JK=1,KFIELDS
    KM =  D_MYMS(KMLOC)
