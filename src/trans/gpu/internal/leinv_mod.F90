...
IIN_STRIDES0 = KFIELDS
IIN_STRIDES1 = IIN_STRIDES0 * MAX((R%NTMAX+2)/2,(R%NTMAX+3)/2)
IOUT_STRIDES0 = KFIELDS
IOUT_STRIDES1 = IOUT_STRIDES0 * R_NDGNH
IIN0_STRIDES0 = KFIELDS/2
IIN0_STRIDES1 = IIN0_STRIDES0 * MAX((R%NTMAX+2)/2,(R%NTMAX+3)/2)
IOUT0_STRIDES0 = KFIELDS/2
IOUT0_STRIDES1 = IOUT0_STRIDES0 * R_NDGNH
