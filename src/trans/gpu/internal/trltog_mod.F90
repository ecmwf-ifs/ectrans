...
#define TRLTOG_DTYPE MPI_DOUBLE_PRECISION
...
#ifdef ACCGPU
  !$ACC DATA &
  !$ACC PRESENT(PGLAT) COPYIN(IIN_TO_SEND_BUFR,IGP_OFFSETS) ASYNC(1)
  ...
  IF(ISENDTOT(MYPROC) > 0) THEN
    ...
    ELSE
      ...
      !$OMP&            PGLAT,PGP3A,IGP3ALEVS,IGP3APARS,PGP3B,&
