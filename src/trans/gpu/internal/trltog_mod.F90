 ...
 &                            PGP,PGPUV,PGP3A,PGP3B,PGP2)
  ...
  IF( IRECVTOT(MYPROC) > 0 )THEN
    ...
    IF (LLPGPONLY) THEN
      ...
      !$OMP&     SHARED(NGPBLKS,IFLDS,JK_MAX,IGPTRSEND,MYSETW,INDOFF,MYPROC, &
      !$OMP&            IGPTROFF,LLINDER,KPTRGP,PGP,PGLAT,KINDEX,IFLDOFF)
#endif
#ifdef ACCGPU
    ...
    ELSE
      ...
      !$OMP&            IGP3BLEVS,IGP3BPARS,KINDEX,IFLDOFF)
#endif
#ifdef ACCGPU
      !$ACC PARALLEL LOOP DEFAULT(NONE) PRIVATE(IPOS,IFIRST,ILAST,IFLD,JK) &
      !$ACC     COPYIN(IGPTROFF,IFLDOFF,JK_MAX) COLLAPSE(3)
