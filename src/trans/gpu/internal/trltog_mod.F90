...
#define TRLTOG_DTYPE MPI_REAL8
...
#ifdef OMPGPU
    !$OMP TARGET DATA MAP(ECTRANS_MAP_PRESENT_ALLOC:PGP) IF(PRESENT(PGP))
    ...
    !$OMP TARGET DATA MAP(TO:IIN_TO_SEND_BUFR) MAP(ECTRANS_MAP_PRESENT_ALLOC:PREEL_REAL) IF(KF_FS > 0)
#endif
#ifdef ACCGPU
