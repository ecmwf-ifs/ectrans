...
#endif
#ifdef OMPGPU
!$OMP TARGET DATA MAP(ALLOC:D_NPTRLS,G_NMEN,D_NPROCM,D_NSTAGT0B,D_MSTABF,D_NPNTGTB0,FOUBUF,PREEL,D_NSTAGTF)
!$OMP TARGET PARALLEL DO COLLAPSE(3) PRIVATE(IGLG,IPROC,ISTA) DEFAULT(NONE) &
...
!$ACC&              D_NPROCM,D_NSTAGT0B,D_MSTABF,D_NPNTGTB0,PREEL,D_NSTAGTF,FOUBUF)
#endif
