...
!$ACC PARALLEL LOOP COLLAPSE(2) PRIVATE(IGLG,IOFF_LAT,JM,IPROC,ISTA) DEFAULT(NONE) ASYNC(1)
DO KGL=IBEG,IEND,IINC
  DO JF=1,KF_CURRENT
    IGLG = OFFSET_VAR+KGL-1
    IOFF_LAT = KF_TOTAL*D_NSTAGTF(KGL)+(JF-1)*(D%NSTAGTF(KGL+1)-D%NSTAGTF(KGL))
