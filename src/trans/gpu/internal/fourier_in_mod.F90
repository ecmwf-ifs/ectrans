...
#ifdef ACCGPU
!$ACC DATA PRESENT(G_NLOEN,G_NLOEN_MAX,G_NMEN,D_NPROCM,D_NSTAGT0B,D_NPNTGTB0,FOUBUF,PREEL_COMPLEX,D_NSTAGTF) ASYNC(1)
#endif
#ifdef OMPGPU
...
#ifdef ACCGPU
!$ACC PARALLEL LOOP DEFAULT(NONE) PRIVATE(IGLG,IOFF_LAT,JM,IPROC,ISTA,RET_REAL,RET_COMPLEX) &
!$ACC&              FIRSTPRIVATE(IBEG,IEND,IINC,KF_CURRENT,OFFSET_VAR,KF_TOTAL,D_NDGL_FS) ASYNC(1) TILE(32,8,1)
#endif
DO KGL=1,D_NDGL_FS
  DO JF=1,KF_CURRENT
