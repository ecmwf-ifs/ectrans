...
#endif
#ifdef OMPGPU
!$OMP TARGET DATA MAP(ECTRANS_MAP_PRESENT_ALLOC:PSPSCALAR) IF(KF_SCALARS > 0 .AND. PRESENT(PSPSCALAR))
!$OMP TARGET DATA MAP(ECTRANS_MAP_PRESENT_ALLOC:PSPSC2)  IF(NF_SC2 > 0)
!$OMP TARGET DATA MAP(ECTRANS_MAP_PRESENT_ALLOC:PSPSC3A) IF(NF_SC3A > 0)
!$OMP TARGET DATA MAP(ECTRANS_MAP_PRESENT_ALLOC:PSPSC3B) IF(NF_SC3B > 0)
#endif
