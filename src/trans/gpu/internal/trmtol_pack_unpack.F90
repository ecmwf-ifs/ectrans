...
CONTAINS
  ...
  END FUNCTION
  SUBROUTINE TRMTOL_PACK(ALLOCATOR,HTRMTOL_PACK,ZOUTS,ZOUTA,FOUBUF_IN,KF_LEG)
    ...
    !$OMP&            MAP(PRESENT,ALLOC:ZOUTS,ZOUTA,FOUBUF_IN,D_OFFSETS_GEMM1)
#endif
#ifdef ACCGPU
    !$ACC DATA PRESENT(D,D_MYMS,D_NPNTGTB1,D_NUMP,G,G_NDGLU,R,R_NDGNH,R_NDGL) &
    !$ACC&     PRESENT(ZOUTS,ZOUTA,FOUBUF_IN,D_OFFSETS_GEMM1)
#endif
