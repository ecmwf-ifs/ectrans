...
CONTAINS
  FUNCTION PREPARE_TRMTOL_PACK(ALLOCATOR,KF_LEG) RESULT(HTRMTOL_PACK)
    ...
    HTRMTOL_PACK%HFOUBUF_IN = RESERVE_GAM(ALLOCATOR, IALLOC_SZ, "HTRMTOL_PACK%HFOUBUF_IN")
  END FUNCTION
  SUBROUTINE TRMTOL_PACK(ALLOCATOR,HTRMTOL_PACK,ZOUTS,ZOUTA,ZOUTS0,ZOUTA0,FOUBUF_IN,KF_LEG)
    ...
    CALL ASSIGN_PTR(FOUBUF_IN, GET_ALLOCATION_GAM(ALLOCATOR, HTRMTOL_PACK%HFOUBUF_IN),&
