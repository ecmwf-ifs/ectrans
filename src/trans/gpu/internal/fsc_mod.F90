...
#ifdef OMPGPU
    !$OMP TARGET PARALLEL DO DEFAULT(NONE) PRIVATE(IR,II,ZAMP,ZPHASE) &
    !$OMP&    SHARED(KF_SCALARS,IMEN,ISTAGTF,PSCALAR,ZSHIFT)
#endif
#ifdef ACCGPU
    !$ACC PARALLEL LOOP DEFAULT(NONE) PRIVATE(IR,II,ZAMP,ZPHASE) &
    !$ACC&    PRESENT(KF_SCALARS,IMEN,ISTAGTF,PSCALAR,ZSHIFT)
#endif
    DO JF=1,KF_SCALARS
      DO JM=0,IMEN
        IR = ISTAGTF+2*JM+1
...
#ifdef OMPGPU
      !$OMP TARGET PARALLEL DO DEFAULT(NONE) PRIVATE(IR,II,ZAMP,ZPHASE) &
      !$OMP&    SHARED(KF_SCALARS,IMEN,ISTAGTF,PNSDERS,ZSHIFT)
#endif
#ifdef ACCGPU
      !$ACC PARALLEL LOOP DEFAULT(NONE) PRIVATE(IR,II,ZAMP,ZPHASE) &
      !$ACC&    PRESENT(KF_SCALARS,IMEN,ISTAGTF,PNSDERS,ZSHIFT)
#endif
      DO JF=1,KF_SCALARS
        DO JM=0,IMEN
          IR = ISTAGTF+2*JM+1
...
#ifdef OMPGPU
    !$OMP TARGET PARALLEL DO DEFAULT(NONE) PRIVATE(IR,II,ZAMP,ZPHASE) &
    !$OMP&   SHARED(KF_UV,IMEN,ISTAGTF,PUV,ZSHIFT)
#endif
#ifdef ACCGPU
    !$ACC PARALLEL LOOP DEFAULT(NONE) PRIVATE(IR,II,ZAMP,ZPHASE) &
    !$ACC&   PRESENT(KF_UV,IMEN,ISTAGTF,PUV,ZSHIFT)
#endif
    DO JF=1,2*KF_UV
      DO JM=0,IMEN
        IR = ISTAGTF+2*JM+1
...
#endif
#ifdef ACCGPU
  !$ACC PARALLEL LOOP DEFAULT(NONE) PRESENT(ISTAGTF,IMEN,KF_UV,PUV,ZACHTE2)
#endif
...
#endif
#ifdef ACCGPU
  !$ACC PARALLEL LOOP DEFAULT(NONE) PRESENT(ISTAGTF,IMEN,KF_SCALARS,PNSDERS,ZACHTE2)
#endif
  DO JLON=ISTAGTF+1,ISTAGTF+2*IMEN+1
    DO JF=1,KF_SCALARS
...
#endif
#ifdef ACCGPU
  !$ACC PARALLEL LOOP PRIVATE(IR) DEFAULT(NONE) PRESENT(ISTAGTF,IMEN,KF_UV,PUVDERS,ZACHTE2,PUV)
#endif
  DO JM=0,IMEN
    DO JF=1,2*KF_UV
      IR = ISTAGTF+2*JM+1
...
#endif
#ifdef ACCGPU
  !$ACC PARALLEL LOOP PRIVATE(IR) DEFAULT(NONE) PRESENT(ISTAGTF,IMEN,KF_SCALARS,PEWDERS,ZACHTE2,PSCALAR)
#endif
  DO JM=0,IMEN
    DO JF=1,KF_SCALARS
      IR = ISTAGTF+2*JM+1
