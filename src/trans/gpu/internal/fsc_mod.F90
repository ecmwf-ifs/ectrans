...
#endif
#ifdef ACCGPU
  !$ACC PARALLEL LOOP COLLAPSE(2) DEFAULT(NONE) PRIVATE(IGLG,IMEN,ISTAGTF,ZACHTE2,IR,JM,JF,KGL) &
  !$ACC& FIRSTPRIVATE(IBEG,IEND,IINC,MYSETW) ASYNC(1)
#endif
  DO KGL=IBEG,IEND,IINC
...
#endif
#ifdef ACCGPU
  !$ACC PARALLEL LOOP COLLAPSE(2) DEFAULT(NONE) PRIVATE(IGLG,IMEN,ISTAGTF,ZACHTE2,IR,KGL,JF,JM) &
  !$ACC& FIRSTPRIVATE(IBEG,IEND,IINC,MYSETW) ASYNC(1)
#endif
  DO KGL=IBEG,IEND,IINC
...
#endif
#ifdef ACCGPU
  !$ACC PARALLEL LOOP COLLAPSE(2) DEFAULT(NONE) PRIVATE(IGLG,IMEN,ISTAGTF,ZACHTE2,JF_UV,IR,JM,JF,KGL) &
  !$ACC& FIRSTPRIVATE(IBEG,IEND,IINC,MYSETW) ASYNC(1)
#endif
  DO KGL=IBEG,IEND,IINC
...
#endif
#ifdef ACCGPU
  !$ACC PARALLEL LOOP COLLAPSE(2) DEFAULT(NONE) PRIVATE(IGLG,IMEN,ISTAGTF,ZACHTE2,JF_SCALAR,IR,JM,JF,KGL) &
  !$ACC& FIRSTPRIVATE(IBEG,IEND,IINC,MYSETW) ASYNC(1)
#endif
  DO KGL=IBEG,IEND,IINC
