...
!$OMP& SHARED(IBEG,IEND,IINC,KF_UV,OFFSET_VAR,KF_FS,KUV_OFFSET,PREEL_COMPLEX) &
...
IF (KSCALARS_NSDER_OFFSET >= 0) THEN
  ...
  !$OMP& SHARED(IBEG,IEND,IINC,KF_SCALARS,OFFSET_VAR,KF_FS,KSCALARS_NSDER_OFFSET,&
  !$OMP&        PREEL_COMPLEX) &
...
IF (KUV_EWDER_OFFSET >= 0) THEN
  ...
  !$OMP& SHARED(IBEG,IEND,IINC,KF_UV,ILOEN_MAX,OFFSET_VAR,KF_FS,KUV_OFFSET,KUV_EWDER_OFFSET,&
  !$OMP&        PREEL_COMPLEX) &
...
IF (KSCALARS_EWDER_OFFSET > 0) THEN
  ...
  !$OMP& SHARED(IBEG,IEND,IINC,KF_SCALARS,ILOEN_MAX,OFFSET_VAR,KF_FS,KSCALARS_EWDER_OFFSET,&
  !$OMP&        KSCALARS_OFFSET,PREEL_COMPLEX) &
