...
#endif
#ifdef OMPGPU
!$OMP TARGET DATA MAP(ALLOC:FOUBUF_IN,ZGTF, D_NPTRLS,G_NMEN,D_NPROCM,D_NSTAGT1B,D_MSTABF,D_NPNTGTB0,D_NSTAGTF) MAP(TO:IBEG,IEND,IINC)
!$OMP TARGET PARALLEL DO DEFAULT(NONE) COLLAPSE(3) PRIVATE(IGLG,JMMAX,IPROC,ISTA,IOFF) &
...
!$ACC &   PRESENT(IBEG,IEND,IINC,G_NMEN_MAX,D_NPTRLS,G_NMEN, &
!$ACC&           D_NPROCM,D_NSTAGT1B,D_MSTABF,D_NPNTGTB0,D_NSTAGTF,FOUBUF_IN,ZGTF) &
!$ACC&    COPYIN(KFIELDS,MYSETW)
#endif
