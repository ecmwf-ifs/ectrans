...
!$ACC DATA PRESENT(G_NMEN,D_NPROCM,D_NSTAGT0B,D_NPNTGTB0,FOUBUF_IN,PREEL_COMPLEX,D_NSTAGTF,G_NLOEN) ASYNC(1)

! scale results and move into next transformation buffer

OFFSET_VAR=D_NPTRLS(MYSETW)
!$ACC PARALLEL LOOP COLLAPSE(2) PRIVATE(IGLG,IOFF_COMPLEX,JM,IPROC,ISTA,SCAL) DEFAULT(NONE) ASYNC(1)
