...
!$ACC DATA PRESENT(D,G_NLOEN,D_NPNTGTB0,FOUBUF_IN,PREEL_COMPLEX,G_NMEN,D_NSTAGTF) ASYNC(1)
...
!$ACC&  FIRSTPRIVATE(OFFSET_VAR,R_NSMAX) DEFAULT(NONE) ASYNC(1) TILE(32,8,1)
#endif
DO KGL=1,D%NDGL_FS
