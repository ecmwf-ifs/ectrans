...
INTEGER(KIND=JPIM) :: IBEG,IEND,IINC, IOFF,D_NDGL_FS
...
#endif
#ifdef ACCGPU
!$ACC PARALLEL LOOP DEFAULT(NONE) COLLAPSE(2) PRIVATE(IGLG,IPROC,ISTA,IOFF,JM) FIRSTPRIVATE(D_NDGL_FS,KF_FS,MYSETW,OFFSET_VAR)
#endif
DO KGL=1,D_NDGL_FS
  DO JF=1,KF_FS
