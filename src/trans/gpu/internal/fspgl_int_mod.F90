...
USE TPM_DISTR       ,ONLY : D,D_NUMP,D_MYMS,D_NASM0,D_NPROCL,D_NSTAGT0B,D_NSTAGT1B,D_NPNTGTB0,D_NPNTGTB1
...
DO JGL=ISL,IDGNH
  IPROC = D_NPROCL(JGL)
  ISTAN(JGL) = (D_NSTAGT1B(IPROC) + D_NPNTGTB1(KMLOC,JGL))*2*KF_OUT_LT
  IGLS = IDGL+1-JGL
  IPROCS = D_NPROCL(IGLS)
  ISTAS(JGL) = (D_NSTAGT1B(IPROCS) + D_NPNTGTB1(KMLOC,IGLS))*2*KF_OUT_LT
ENDDO
