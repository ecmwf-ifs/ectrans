...
#endif
#ifdef ACCGPU
!$ACC PARALLEL LOOP DEFAULT(NONE) PRIVATE(KM,ISL,IPROC,ISTAN,IGLS,IPROCS,ISTAS) COPYIN(KFIELD), &
!$ACC       PRESENT(D_NUMP,D_MYMS,R_NDGNH,G_NDGLU,D_NPROCL,D_NSTAGT0B,D_NPNTGTB1,R_NDGL,FOUBUF_IN,PAOA,PSOA)
#endif
DO KMLOC=1,D_NUMP
  KM = D_MYMS(KMLOC)
