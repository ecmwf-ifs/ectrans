...
#ifdef OMPGPU
!$OMP TARGET PARALLEL DO DEFAULT(NONE) COLLAPSE(3) PRIVATE(KM,ISL,IGLS,OFFSET1,OFFSET2) &
...
!$ACC&    PRESENT(D_NUMP,R_NDGNH,KFIELD,D_MYMS,G_NDGLU,R_NDGL,D_NSTAGT1B,D_NPROCL,D_NPNTGTB1,KMODE,PAIA,FOUBUF)
#endif
DO KMLOC=1,D_NUMP
     DO JGL=1,R_NDGNH
        DO JF=1,KFIELD*2
