...
CALL FOURIER_IN(FOUBUF,PREEL_COMPLEX,KFIELD/2,KF_FS)
...
!   3.  Fourier transform
! inplace operation
IF (KF_FS > 0) CALL FTINV(PREEL_COMPLEX,PREEL_REAL,KF_FS)
...
CALL GSTATS(157,0)
CALL TRLTOG_CUDAAWARE(PREEL_REAL,KF_FS,KF_GP,KF_UV_G,KF_SCALARS_G,IVSET,&
 &PGP=PGP,PGPUV=PGPUV,PGP3A=PGP3A,PGP3B=PGP3B,PGP2=PGP2)
CALL GSTATS(157,1)
!     ------------------------------------------------------------------
!     ------------------------------------------------------------------
