...
USE TPM_DISTR,       ONLY: LEQ_REGIONS, MTAGDISTGP, MTAGDISTSP, MTAGGL, MTAGLETR, MTAGLG, MTAGLM, &
  &                        MTAGML, MTAGPART, MYSETV, MYSETW, NPRCIDS, NPRGPEW, NPRGPNS, NPRTRNS, &
  &                        NPRTRV, NPRTRW, MYPROC, NPROC
USE EQ_REGIONS_MOD,  ONLY: EQ_REGIONS, MY_REGION_EW, MY_REGION_NS, N_REGIONS, N_REGIONS_EW, &
  &                        N_REGIONS_NS
