...
CALL SET_RESOL(KRESOL)
  ...
  IF (S%LUSEFLT) THEN
    !$ACC EXIT DATA DELETE(FG%Y_BUT_FLAT_A%SLEV_NODE_ICLIST) &
    ...
    !$ACC EXIT DATA DELETE(FG%Y_BUT_FLAT_S%SLEV_NODE_ICLIST) &
  ...
  IF (S%LUSEFLT) THEN
    !$OMP TARGET EXIT DATA MAP(DELETE:FG%Y_BUT_FLAT_A%SLEV_NODE_ICLIST) &
    ...
    !$OMP TARGET EXIT DATA MAP(DELETE:FG%Y_BUT_FLAT_S%SLEV_NODE_ICLIST) &
