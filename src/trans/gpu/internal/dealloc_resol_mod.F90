...
IF (S%LUSEFLT) THEN
  !$ACC EXIT DATA DELETE(FG%YD_BUTTERFLY_FLAT_A%N_ORDER) &
  !$ACC&          DELETE(FG%YD_BUTTERFLY_FLAT_A%N_LEVELS) &
  !$ACC&          DELETE(FG%YD_BUTTERFLY_FLAT_A%IBETALEN_MAX) ASYNC(1)
  !$ACC EXIT DATA DELETE(FG%YD_BUTTERFLY_FLAT_A) ASYNC(1)
  !$ACC EXIT DATA DELETE(FG%YD_BUTTERFLY_FLAT_S%N_ORDER) &
  !$ACC&          DELETE(FG%YD_BUTTERFLY_FLAT_S%N_LEVELS) &
  !$ACC&          DELETE(FG%YD_BUTTERFLY_FLAT_S%IBETALEN_MAX) ASYNC(1)
  !$ACC EXIT DATA DELETE(FG%YD_BUTTERFLY_FLAT_S) ASYNC(1)
ENDIF
...
IF (S%LUSEFLT) THEN
  !$OMP TARGET EXIT DATA MAP(DELETE:FG%YD_BUTTERFLY_FLAT_A%N_ORDER) &
  !$OMP&                 MAP(DELETE:FG%YD_BUTTERFLY_FLAT_A%N_LEVELS) &
  !$OMP&                 MAP(DELETE:FG%YD_BUTTERFLY_FLAT_A%IBETALEN_MAX)
  !$OMP TARGET EXIT DATA MAP(DELETE:FG%YD_BUTTERFLY_FLAT_A)
  !$OMP TARGET EXIT DATA MAP(DELETE:FG%YD_BUTTERFLY_FLAT_S%N_ORDER) &
  !$OMP&                 MAP(DELETE:FG%YD_BUTTERFLY_FLAT_S%N_LEVELS) &
  !$OMP&                 MAP(DELETE:FG%YD_BUTTERFLY_FLAT_S%IBETALEN_MAX)
  !$OMP TARGET EXIT DATA MAP(DELETE:FG%YD_BUTTERFLY_FLAT_S)
ENDIF
