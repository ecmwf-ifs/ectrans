...
!WARNING: following lines should be PRESENT,ALLOC but cause issues with AMD compiler!
  ...
  CALL GSTATS(1602,0)
    DO INS=1,INSEND
      ...
      !$OMP& SHARED(ISEND_FLD_END,NGPBLKS,IFLDA,ISETW,IPOS,JK_MAX,IGPTRSEND,LLINDER,LLPGPONLY, &
      ...
      !$ACC  COPYIN(NGPBLKS,INS,JK_MAX,IFLDA,IPOS,ISETW,LLINDER,LLPGPONLY,ISEND_FLD_CNT,IGPTROFF) &
      !$ACC& PRESENT(IGPTRSEND,LLUV,LLGP2,LLGP3A,LLGP3B,ZCOMBUFS,KPTRGP,PGP,PGPUV,PGP2,PGP3A,PGP3B, &
      !$ACC&        IGP2PARS,IGP3ALEVS,IGP3APARS) ASYNC(1)
#endif
#endif
