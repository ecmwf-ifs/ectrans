...
MODULE TRGTOL_MOD
  ...
  TYPE GRID_TO_FOURIER_HANDLE
    TYPE(ALLOCATION_RESERVATION_HANDLE) :: HCOMBUFS, HCOMBUFR_AND_REEL
  END TYPE
  CONTAINS
  SUBROUTINE TRGTOL_CUDAAWARE(ALLOCATOR,HGRID_TO_FOURIER,PREEL_REAL,KF_FS,KF_GP,KVSET,KPTRGP,&
...
#define TRGTOL_DTYPE MPI_DOUBLE_PRECISION
  ...
  CALL ASSIGN_PTR(PREEL_REAL, GET_ALLOCATION(ALLOCATOR, HGRID_TO_FOURIER%HCOMBUFR_AND_REEL),&
...
!WARNING: following lines should be PRESENT,ALLOC but cause issues with AMD compiler!
  ...
  CALL ASSIGN_PTR(ZCOMBUFS, GET_ALLOCATION(ALLOCATOR, HGRID_TO_FOURIER%HCOMBUFS),&
  ...
  CALL GSTATS(411,0)
  CALL ASSIGN_PTR(ZCOMBUFR, GET_ALLOCATION(ALLOCATOR, HGRID_TO_FOURIER%HCOMBUFR_AND_REEL),&
