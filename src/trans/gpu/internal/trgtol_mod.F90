...
#define TRGTOL_DTYPE MPI_REAL8
...
#ifdef OMPGPU
    !$OMP TARGET DATA MAP(TO:IRECV_BUFR_TO_OUT) MAP(ECTRANS_MAP_PRESENT_ALLOC:PREEL_REAL) IF (KF_FS > 0)
    ...
    ENDIF
#ifdef OMPGPU
    !$OMP TARGET DATA MAP(ECTRANS_MAP_PRESENT_ALLOC:PGP) IF(PRESENT(PGP) .AND. KF_GP > 0)
    !$OMP TARGET DATA MAP(ECTRANS_MAP_PRESENT_ALLOC:PGPUV) IF(PRESENT(PGPUV))
    !$OMP TARGET DATA MAP(ECTRANS_MAP_PRESENT_ALLOC:PGP2) IF(PRESENT(PGP2))
    !$OMP TARGET DATA MAP(ECTRANS_MAP_PRESENT_ALLOC:PGP3A) IF(PRESENT(PGP3A))
    !$OMP TARGET DATA MAP(ECTRANS_MAP_PRESENT_ALLOC:PGP3B) IF(PRESENT(PGP3B))
#endif
#ifdef ACCGPU
    ...
    !....Pack loop.........................................................
#ifdef OMPGPU
    !$OMP TARGET DATA MAP(ECTRANS_MAP_PRESENT_ALLOC:ZCOMBUFS) IF(ISEND_COUNTS > 0)
#endif
#ifdef ACCGPU
    ...
    DO INS=1,ISEND_COUNTS
      ...
      ELSE
#ifdef OMPGPU
        !$OMP TARGET TEAMS DISTRIBUTE PARALLEL DO COLLAPSE(2) DEFAULT(ECTRANS_OMP_DEFAULT) PRIVATE(JK,JBLK,IFLD,&
    ...
    ENDIF
#ifdef OMPGPU
    !$OMP TARGET DATA MAP(ECTRANS_MAP_PRESENT_ALLOC:ZCOMBUFR) IF(IRECV_COUNTS > 0)
#endif
#ifdef ACCGPU
...
#ifdef OMPGPU
      !$OMP TARGET TEAMS DISTRIBUTE PARALLEL DO COLLAPSE(2) DEFAULT(ECTRANS_OMP_DEFAULT) PRIVATE(IPOS) &
