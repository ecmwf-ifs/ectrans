...
#ifdef ACCGPU
  !$ACC DATA PRESENT(PGLAT) COPYIN(KPTRGP,ZCOMBUFR_PROC_OFFSET,ZCOMBUFR_TO_PGLAT,PGP_INDICES) ASYNC(1)
...
!WARNING: following lines should be PRESENT,ALLOC but cause issues with AMD compiler!
  ...
  IF(PRESENT(PGP)) THEN
    ...
    !$ACC&   FIRSTPRIVATE(NGPBLKS,KF_FS,MYSETW,MYPROC,IWPOINTS_COUNT,IWPOINTS_OFFSET,NPROMA) ASYNC(1)
#endif
  ...
  ELSE
    ...
    !$ACC& COPYIN(NGPBLKS,IFLDS,MYSETW,MYPROC,KF_FS,IWPOINTS_COUNT,IWPOINTS_OFFSET,NPROMA) &
    !$ACC& PRESENT(PGLAT,PGPUV,PGP2,PGP3A,PGP3B) ASYNC(1)
#endif
#endif
    DO JL=1,IWPOINTS_COUNT
  ...
  CALL GSTATS(1602,0)
    DO INS=1,INSEND
      ...
      !$ACC  COPYIN(NGPBLKS,ISEND_FLD_CNT,INS,IFLDA,IPOS,ISETW,IWPOINTS_COUNT,IWPOINTS_OFFSET,NPROMA,SEND_OFFSET) &
      !$ACC& PRESENT(ZCOMBUFS,KPTRGP,PGP,PGPUV,PGP2,PGP3A,PGP3B) ASYNC(1)
#endif
#endif
      DO JL=1,IWPOINTS_COUNT
      ...
      ELSE
        ...
        !$ACC&  FIRSTPRIVATE(IWPOINTS_COUNT,IWPOINTS_OFFSET,ISEND_FLD_CNT,NPROMA,SEND_OFFSET)
#endif
        DO JL=1,IWPOINTS_COUNT
          DO JFLD=1,ISEND_FLD_CNT
            JK = MOD(IWPOINTS_OFFSET+JL-1,NPROMA)+1
...
!$ACC WAIT(1)
  ...
  DO INR=1,INRECV
      ...
      !$ACC& FIRSTPRIVATE(KF_FS,ILEN,INDOFFL,RECV_OFFSET,JFLD) ASYNC(1)
#endif
      DO JFLD=1,KF_FS
        DO JL=1,ILEN
