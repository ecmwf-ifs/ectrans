...
INTEGER(KIND=JPIM), ALLOCATABLE :: SLEV_NODE_ICLIST_OFFSET(:)
INTEGER(KIND=JPIM), ALLOCATABLE :: SLEV_NODE_ICLIST(:) ! Will be copied to device
INTEGER(KIND=JPIM), ALLOCATABLE :: SLEV_NODE_PNONIM_OFFSET(:)
REAL(KIND=JPRBT),   ALLOCATABLE :: SLEV_NODE_PNONIM(:) ! Will be copied to device
INTEGER(KIND=JPIM), ALLOCATABLE :: SLEV_NODE_B_OFFSET(:)
REAL(KIND=JPRBT),   ALLOCATABLE :: SLEV_NODE_B(:) ! Will be copied to device
