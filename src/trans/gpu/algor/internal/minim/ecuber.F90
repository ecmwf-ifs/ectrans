      SUBROUTINE ECUBER(T,F,FP,TA,FA,FPA,TLOWER,TUPPER)
!AUTOPROMOTE
...
!
      ...
      IF (LHOOK) CALL DR_HOOK('ECUBER',0,ZHOOK_HANDLE)
...
!
  ...
  900 T=MAX(T,TLOWER)
      T=MIN(T,TUPPER)
      IF (LHOOK) CALL DR_HOOK('ECUBER',1,ZHOOK_HANDLE)
      ENDSUBROUTINE ECUBER
!
!-----------------------------------------------------------------------
!
