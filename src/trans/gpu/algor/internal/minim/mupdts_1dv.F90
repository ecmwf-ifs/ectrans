      SUBROUTINE MUPDTS_1DV (SSCALE,INMEMO,N,M,NRZ)
!AUTOPROMOTE
...
!
      ...
      IF (LHOOK) CALL DR_HOOK('MUPDTS_1DV',0,ZHOOK_HANDLE)
      M=(NRZ-4*N)/(2*N+1)
      INMEMO=.TRUE.
      IF (LHOOK) CALL DR_HOOK('MUPDTS_1DV',1,ZHOOK_HANDLE)
      ENDSUBROUTINE MUPDTS_1DV
