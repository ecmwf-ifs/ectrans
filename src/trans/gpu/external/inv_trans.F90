...
IF(PRESENT(KVSETSC2)) THEN
  IF(.NOT.PRESENT(PSPSC2)) THEN
    CALL ABORT_TRANS('INV_TRANS:KVSETSC2 PRESENT BUT NOT PSPSC2')
  ENDIF
...
IF(PRESENT(KVSETSC3A)) THEN
  IF(.NOT.PRESENT(PSPSC3A)) THEN
    CALL ABORT_TRANS('INV_TRANS:KVSETSC3A PRESENT BUT NOT PSPSC3A')
  ENDIF
...
IF(PRESENT(KVSETSC3B)) THEN
  IF(.NOT.PRESENT(PSPSC3B)) THEN
    CALL ABORT_TRANS('INV_TRANS:KVSETSC3B PRESENT BUT NOT PSPSC3B')
  ENDIF
...
IF (IF_UV > 0) THEN
  ...
  IF(UBOUND(PSPVOR,1) /= IF_UV) THEN
    ...
    CALL ABORT_TRANS('INV_TRANS : PSPVOR /= IF_UV')
  ENDIF
  ...
  IF(UBOUND(PSPDIV,1) /= IF_UV) THEN
    ...
    CALL ABORT_TRANS('INV_TRANS : PSPDIV /= IF_UV')
  ENDIF
ENDIF
...
IF (IF_SCALARS > 0) THEN
  IF(PRESENT(PSPSCALAR)) THEN
    ...
    IF(UBOUND(PSPSCALAR,1) /= IF_SCALARS) THEN
      ...
      CALL ABORT_TRANS('INV_TRANS : PSPSCALAR /= IF_SCALARS')
    ENDIF
  ELSEIF(PRESENT(PSPSC3A)) THEN
  ENDIF
ENDIF
...
IF(PRESENT(PGP)) THEN
  ...
  IF(IUBOUND(1) /= NPROMA) THEN
    WRITE(NOUT,*)'INV_TRANS:FIRST DIMENSION OF PGP /= NPROMA',IUBOUND(1),NPROMA
    CALL ABORT_TRANS('INV_TRANS:FIRST DIMENSION OF PGP /= NPROMA')
  ENDIF
  IF(IUBOUND(2) /= IF_GP) THEN
    WRITE(NOUT,*)'INV_TRANS:SECOND DIMENSION OF PGP /= IF_GP',IUBOUND(2),IF_GP
  ...
  IF(IUBOUND(3) /= NGPBLKS) THEN
    WRITE(NOUT,*)'INV_TRANS:THIRD DIMENSION OF PGP /= NGPBLKS',IUBOUND(3),NGPBLKS
    CALL ABORT_TRANS('INV_TRANS:THIRD DIMENSION OF PGP /= NGPBLKS')
  ENDIF
ELSE
...
IF(PRESENT(PGPUV)) THEN
  ...
  IF(IUBOUND(1) /= NPROMA) THEN
    WRITE(NOUT,*)'INV_TRANS:FIRST DIMENSION OF PGPUV /= NPROMA',IUBOUND(1),NPROMA
    CALL ABORT_TRANS('INV_TRANS:FIRST DIMENSION OF PGPUV /= NPROMA')
  ENDIF
  ...
  IF(IUBOUND(4) /= NGPBLKS) THEN
    ...
    CALL ABORT_TRANS('INV_TRANS:FOURTH DIMENSION OF PGPUV /= NGPBLKS')
  ENDIF
ENDIF
IF(PRESENT(PGP2)) THEN
  IF(.NOT.PRESENT(PSPSC2)) THEN
...
IF(IF_SC2_G > 0) THEN
  IF(PRESENT(PGP2)) THEN
    ...
    IF(IUBOUND(1) /= NPROMA) THEN
      WRITE(NOUT,*)'INV_TRANS:FIRST DIMENSION OF PGP2 /= NPROMA',IUBOUND(1),NPROMA
      CALL ABORT_TRANS('INV_TRANS:FIRST DIMENSION OF PGP2 /= NPROMA')
    ENDIF
    IF(IUBOUND(2) /= IF_SC2_G) THEN
      WRITE(NOUT,*)'INV_TRANS:SECOND DIMENSION OF PGP2 /= IF_SC2_G',IUBOUND(2),IF_SC2_G
      CALL ABORT_TRANS('INV_TRANS:SECOND DIMENSION OF PGP2 /= IF_SC2_G')
    ENDIF
    IF(IUBOUND(3) /= NGPBLKS) THEN
      WRITE(NOUT,*)'INV_TRANS:THIRD DIMENSION OF PGP2 /= NGPBLKS',IUBOUND(3),NGPBLKS
      CALL ABORT_TRANS('INV_TRANS:THIRD DIMENSION OF PGP2 /= NGPBLKS')
    ENDIF
  ELSE
...
IF(IF_SC3A_G3 > 0) THEN
  IF(PRESENT(PGP3A)) THEN
    ...
    IF(IUBOUND(1) /= NPROMA) THEN
      WRITE(NOUT,*)'INV_TRANS:FIRST DIMENSION OF PGP3A /= NPROMA',IUBOUND(1),NPROMA
      CALL ABORT_TRANS('INV_TRANS:FIRST DIMENSION OF PGP3A /= NPROMA')
    ENDIF
    IF(IUBOUND(2) /= IF_SC3A_G2) THEN
      WRITE(NOUT,*)'INV_TRANS:SEC DIMENSION OF PGP3A /= IF_SC3A_G2 ',IUBOUND(2),IF_SC3A_G2
      CALL ABORT_TRANS('INV_TRANS:SECOND DIMENSION OF PGP3A /= IF_SC3A_G2 ')
    ENDIF
    IF(IUBOUND(3) /= IF_SC3A_G3 ) THEN
      WRITE(NOUT,*)'INV_TRANS:THIRD DIMENSION OF PGP3A /= IF_SC3A_G3 ',&
       & IUBOUND(3),IF_SC3A_G3
      CALL ABORT_TRANS('INV_TRANS:THIRD DIMENSION OF PGP3A /= IF_SC3A_G3 ')
    ENDIF
    IF(IUBOUND(4) /= NGPBLKS) THEN
      WRITE(NOUT,*)'INV_TRANS:FOURTH DIMENSION OF PGP3A /= NGPBLKS',IUBOUND(4),NGPBLKS
      CALL ABORT_TRANS('INV_TRANS:FOURTH DIMENSION OF PGP3A /= NGPBLKS')
    ENDIF
  ELSE
...
IF(IF_SC3B_G3 > 0) THEN
  IF(PRESENT(PGP3B)) THEN
    ...
    IF(IUBOUND(1) /= NPROMA) THEN
      WRITE(NOUT,*)'INV_TRANS:FIRST DIMENSION OF PGP3B /= NPROMA',IUBOUND(1),NPROMA
      CALL ABORT_TRANS('INV_TRANS:FIRST DIMENSION OF PGP3B /= NPROMA')
    ENDIF
    IF(IUBOUND(2) /= IF_SC3B_G2) THEN
      WRITE(NOUT,*)'INV_TRANS:SEC DIMENSION OF PGP3B /= IF_SC3B_G2 ',IUBOUND(2),IF_SC3B_G2
      CALL ABORT_TRANS('INV_TRANS:SECOND DIMENSION OF PGP3B /= IF_SC3B_G2 ')
    ENDIF
    IF(IUBOUND(3) /= IF_SC3B_G3 ) THEN
      WRITE(NOUT,*)'INV_TRANS:THIRD DIMENSION OF PGP3B /= IF_SC3B_G3 ',&
       & IUBOUND(3),IF_SC3B_G3
      CALL ABORT_TRANS('INV_TRANS:THIRD DIMENSION OF PGP3B /= IF_SC3B_G3 ')
    ENDIF
    IF(IUBOUND(4) /= NGPBLKS) THEN
      WRITE(NOUT,*)'INV_TRANS:FOURTH DIMENSION OF PGP3B /= NGPBLKS',IUBOUND(4),NGPBLKS
      CALL ABORT_TRANS('INV_TRANS:FOURTH DIMENSION OF PGP3B /= NGPBLKS')
    ENDIF
  ELSE
