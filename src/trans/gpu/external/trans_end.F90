...
USE TPM_FIELDS        ,ONLY : F, FIELDS_RESOL,F_RW, ZIA,ZEPSNM,ZOA1,ZOA2, &
&                             ZAA,ZAS,ZAA0,ZAS0
...
#ifdef ACCGPU
  !$ACC EXIT DATA DELETE(ZAA0,ZAS0,ZIA,ZEPSNM,ZOA1,ZOA2,ZAA,ZAS,ZGTF)
#endif
#ifdef OMPGPU
#endif
  DEALLOCATE(ZAA0)
...
#ifdef ACCGPU
  !$ACC EXIT DATA DELETE(R_NSMAX,R_NTMAX,R_NDGL,R_NNOEXTZL,R_NDGNH,D_NSTAGT0B,D_NSTAGT1B,D_NPNTGTB1,D_NPROCL, D_NUMP,D_MYMS, &
