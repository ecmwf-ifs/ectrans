...
USE TPM_FIELDS            ,ONLY : FIELDS_RESOL, F,F_RW, F_RN, F_RLAPIN, F_RACTHE, ZIA,ZEPSNM,ZOA1,ZOA2, &
&                                 ZAA,ZAS,TDZAA,TDZAS,&
&                                 IF_FS_INV0,IF_FS_DIR0,NFLEV0,ZAA0,ZAS0,KMLOC0
! IZBA,IZCAT
...
ZOA2 = 0._JPRBT
#ifdef ACCGPU
!$ACC ENTER DATA COPYIN(ZIA,ZEPSNM,ZOA1,ZOA2)
#endif
#ifdef OMPGPU
