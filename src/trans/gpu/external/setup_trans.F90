...
IF(PRESENT(LDLL)) THEN
  IF (LDLL) THEN
    CALL ABORT_TRANS('SETUP_TRANS: LDLL option is not supported for GPU')
  ENDIF
ENDIF
...
IF(PRESENT(LDSPLIT)) THEN
  IF (LDSPLIT) THEN
    CALL ABORT_TRANS('SETUP_TRANS: LDSPLIT option is not supported for GPU')
  ENDIF
ENDIF
...
IF(PRESENT(LDGRIDONLY)) THEN
  IF (LDGRIDONLY) THEN
    CALL ABORT_TRANS('SETUP_TRANS: LDGRIDONLY option is not supported for GPU')
  ENDIF
ENDIF

IF(PRESENT(LDSPSETUPONLY)) THEN
  IF (LDSPSETUPONLY) THEN
    CALL ABORT_TRANS('SETUP_TRANS: LDSPSETUPONLY option is not supported for GPU')
  ENDIF
ENDIF
