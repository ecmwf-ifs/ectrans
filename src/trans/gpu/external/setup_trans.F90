...
#endif
USE TPM_FLT
USE TPM_TRANS             ,ONLY : ZAVE, ZMINGL, ZMAXGL, ZMINGPN, ZMAXGPN, LEDIR_CONF, LEINV_CONF
USE LEDIR_MOD, ONLY: SETUP_LEDIR
USE LEINV_MOD, ONLY: SETUP_LEINV
USE TPM_CTL
...
CALL SETUP_LEDIR(LEDIR_CONF)
CALL SETUP_LEINV(LEINV_CONF)
