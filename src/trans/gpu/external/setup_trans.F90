...
#endif
WRITE(NOUT,'(A10,":",I9,"B")') 'FG%ZAS', SIZEOF(FG%ZAS)
WRITE(NOUT,'(A10,":",I9,"B")') 'FG%ZAA', SIZEOF(FG%ZAA)
WRITE(NOUT,'(A10,":",I9,"B")') 'FG%ZAS0', SIZEOF(FG%ZAS0)
WRITE(NOUT,'(A10,":",I9,"B")') 'FG%ZAA0', SIZEOF(FG%ZAA0)
WRITE(NOUT,'(A10,":",I9,"B")') 'FG%ZEPSNM', SIZEOF(FG%ZEPSNM)
...
!$ACC ENTER DATA COPYIN(D,D%MYMS,D%NPNTGTB0,D%NPNTGTB1,D%NSTAGT0B,D%NSTAGT1B,D%NSTAGTF,D%NPROCM)&
