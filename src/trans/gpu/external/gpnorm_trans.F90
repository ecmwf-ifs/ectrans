...
#ifdef USE_RAW_MPI
USE MPI_F08,                ONLY: MPI_COMM, MPI_STATUS, MPI_REAL8, &
...
!$OMP& MAP(ALLOC:PREEL_REAL,F_RW,D_NSTAGTF,D_NPTRLS,G_NLOEN)
#endif
#ifdef ACCGPU
...
#endif
#ifdef USE_RAW_MPI
      CALL MPI_RECV(ZRCV(:),ILEN,MPI_REAL8,NPRCIDS(IPROC)-1,ITAG,&
        &LOCAL_COMM,ISTATUS,IERROR)
...
#endif
#ifdef USE_RAW_MPI
    CALL MPI_SEND(ZSND(:),ILEN,MPI_REAL8,NPRCIDS(IPROC)-1,ITAG,&
      &LOCAL_COMM,IERROR)
#else
