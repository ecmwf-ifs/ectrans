...
#ifdef OMPGPU
!$OMP TARGET PARALLEL DO COLLAPSE(3) PRIVATE(KM,ISKIP,ILA,IA)
#endif
#ifdef ACCGPU
...
#endif
CALL CUDA_GEMM_BATCHED('N','T',ITDZCA,ILDZCA,ILDZBA,1.0_JPRB,IZBS,ITDZBA,ILDZBA,&
...
#endif
CALL CUDA_GEMM_BATCHED('N','T',ITDZCS,ILDZCS,ILDZBS,1.0_JPRB,IZBS,ITDZBS,ILDZBS,&
