...
CALL GATH_SPEC_CONTROL(PSPECG=PSPECG,KFGATHG=KFGATHG,KTO=KTO,KVSET=IVSET,PSPEC=PSPEC,LDIM1_IS_FLD=LLDIM1_IS_FLD,&
 KSMAX=ISMAX,KSPEC2=ISPEC2,KSPEC2MX=ISPEC2MX,KSPEC2G=ISPEC2_G,KPOSSP=IPOSSP,KDIM0G=IDIM0G,KUMPP=IUMPP,&
 KALLMS=IALLMS,KPTRMS=IPTRMS,KN=IKN,LDZA0IP=LDZA0IP)
DEALLOCATE(IDIM0G)
