...
IF (PRESENT(PSPECG) .AND. PRESENT(PSPEC)) THEN
  CALL DIST_SPEC_CONTROL(PSPECG=PSPECG,KFDISTG=KFDISTG,KFROM=KFROM,KVSET=IVSET,PSPEC=PSPEC,LDIM1_IS_FLD=LLDIM1_IS_FLD,&
...
ELSE IF (PRESENT(PSPECG) .AND. .NOT. PRESENT(PSPEC)) THEN
   CALL DIST_SPEC_CONTROL(PSPECG=PSPECG,KFDISTG=KFDISTG,KFROM=KFROM,KVSET=IVSET,LDIM1_IS_FLD=LLDIM1_IS_FLD,&
   & KSMAX=ISMAX,KSPEC2=ISPEC2,KSPEC2MX=ISPEC2MX,KSPEC2G=ISPEC2_G,KPOSSP=IPOSSP,KDIM0G=IDIM0G,&
   & KUMPP=IUMPP,KALLMS=IALLMS,KPTRMS=IPTRMS,KN=IKN,KSORT=KSORT)
ELSE IF (.NOT. PRESENT(PSPECG) .AND. PRESENT(PSPEC)) THEN
  CALL DIST_SPEC_CONTROL(KFDISTG=KFDISTG,KFROM=KFROM,KVSET=IVSET,PSPEC=PSPEC,LDIM1_IS_FLD=LLDIM1_IS_FLD,&
   & KSMAX=ISMAX,KSPEC2=ISPEC2,KSPEC2MX=ISPEC2MX,KSPEC2G=ISPEC2_G,KPOSSP=IPOSSP,KDIM0G=IDIM0G,&
   & KUMPP=IUMPP,KALLMS=IALLMS,KPTRMS=IPTRMS,KN=IKN,KSORT=KSORT)
ELSE
  CALL DIST_SPEC_CONTROL(KFDISTG=KFDISTG,KFROM=KFROM,KVSET=IVSET,LDIM1_IS_FLD=LLDIM1_IS_FLD,&
   & KSMAX=ISMAX,KSPEC2=ISPEC2,KSPEC2MX=ISPEC2MX,KSPEC2G=ISPEC2_G,KPOSSP=IPOSSP,KDIM0G=IDIM0G,&
   & KUMPP=IUMPP,KALLMS=IALLMS,KPTRMS=IPTRMS,KN=IKN,KSORT=KSORT)
ENDIF
