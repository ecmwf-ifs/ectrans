...
USE MPL_MODULE, ONLY: MPL_ALLTOALLV, MPL_ALL_MS_COMM
USE TPM_DISTR,  ONLY: D, MYSETW, NPRTRW, NPROC
...
IF (NPROC > 1) THEN
  ...
  CALL MPL_ALLTOALLV(PSENDBUF=PFBUF_IN, KSENDCOUNTS=ILENS, PRECVBUF=PFBUF, KRECVCOUNTS=ILENR, &
    &                KSENDDISPL=IOFFS, KRECVDISPL=IOFFR, KCOMM=MPL_ALL_MS_COMM, CDSTRING='TRMTOL:')
  CALL GSTATS(807, 1)
