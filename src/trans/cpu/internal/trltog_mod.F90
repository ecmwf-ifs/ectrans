...
!              --------------------
ASSOCIATE (KSENDCOUNT=>YDBUFS%ISENDCOUNT, KRECVCOUNT=>YDBUFS%IRECVCOUNT, KNSEND=>YDBUFS%INSEND, KNRECV=>YDBUFS%INRECV, &
         & KSENDTOT=>YDBUFS%ISENDTOT, KRECVTOT=>YDBUFS%IRECVTOT, KSEND=>YDBUFS%ISEND, KRECV=>YDBUFS%IRECV, KINDEX=>YDBUFS%IINDEX, &
         & KNDOFF=>YDBUFS%INDOFF, KGPTRSEND =>YDBUFS%IGPTRSEND, KSETWL=>YDBUFS%ISETWL)
...
DO JNR=1,KNRECV
  ...
  CALL TGRL_COPY_ZCOMBUF(YDBUFS, YLVARS, INR, &
                      &  ZCOMBUFR, &
                      & KPTRGP, &
                      & PGP, PGPUV, PGP3A, PGP3B, PGP2)
ENDDO
