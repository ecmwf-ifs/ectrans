...
USE TRXTOY_CTX_MOD  ,ONLY : TRXTOY_CTX, TRXTOY_VARS, ALLOCATE_TOG_VARS,&
                             &ALLOCATE_HEAP_BUFFER, INIT_TOG_VARS, COPY_ZCOMBUF, COPY_PGLAT
...
DO JNR=1,KNRECV
  ...
  CALL COPY_ZCOMBUF(.TRUE., YDCTX, YDTOGLVARS, INR, &
                      &  ZCOMBUFR,NGPBLKS, LLPGPONLY, LLINDER,&
