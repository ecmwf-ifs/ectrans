...
USE TRXTOY_CTX_MOD  ,ONLY : TRXTOY_CTX, ALLOCATE_HEAP_BUFFER, INIT_TOG_VARIABLES
...
CALL INIT_TOG_VARIABLES(KF_GP, KF_SCALARS_G, IUVLEVS,IUVPARS,IGP2PARS,LLUV,LLGP2,LLGP3A,LLGP3B, &
