...
CONTAINS
    ...
    FUNCTION BATCH_CONSTRUCTOR(KBLK, KF_GP, KF_SCALARS_G, KF_UV_G, KVSETUV, KVSETSC) RESULT(THIS)
        ...
        WRITE(NOUT,*) "Batch", THIS%NBLK, THIS%IOFFGTF
    ...
    SUBROUTINE START_COMM(THIS, PGP, PGTF)
        ...
        CALL TRGTOL(PGTF(THIS%IOFFGTF:THIS%IOFFGTF+THIS%NF_FS-1,:), THIS%NF_FS, THIS%NF_GP, &
          &         THIS%NF_SCALARS_G, THIS%NVSET, THIS%NSENDCOUNT, THIS%NRECVCOUNT, THIS%NNSEND, &
          &         THIS%NNRECV, THIS%NSENDTOT, THIS%NRECVTOT, THIS%NSEND, THIS%NRECV, &
          &         THIS%NINDEX, THIS%NNDOFF, THIS%NGPTRSEND, THIS%PCOMBUFS, THIS%PCOMBUFR, &
          &         THIS%NPTRGP, PGP)
