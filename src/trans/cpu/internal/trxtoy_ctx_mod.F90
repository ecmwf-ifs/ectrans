...
SUBROUTINE ALLOCATE_CTX(SELF, NPROC,NLENGTF, NGPBLKS,NPRTRNS, KF_GP)
  CLASS(TRXTOY_CTX), INTENT(INOUT) :: SELF
  INTEGER(KIND=JPIM), INTENT(IN) :: NPROC,NLENGTF,NGPBLKS,NPRTRNS, KF_GP
...
SUBROUTINE INIT_TOG_PACKING_VARS(YDCTX,YDTOGLVARS, INRS, ISETV, KVSET, NGPBLKS,KF_GP, PCOMBUFS)
  USE PARKIND1  ,ONLY : JPIM, JPRB
...
SUBROUTINE COPY_ZCOMBUF(YDCTX, YDTOGLVARS, INRS,&
  ...
  ASSOCIATE (KSENDCOUNT=>YDCTX%ISENDCOUNT, KRECVCOUNT=>YDCTX%IRECVCOUNT, KNSEND=>YDCTX%INSEND, KNRECV=>YDCTX%INRECV, &
          ...
          & IFLDA=>YDCTX%IFLDA,IPOSPLUS=>YDCTX%IPOSPLUS, JPOS=>YDCTX%IJPOS)
...
SUBROUTINE COPY_PGLAT(YDCTX, YDTOGLVARS, NGPBLKS,IFLDS, LLPGPONLY, LLINDER,&                    
                    & PGP, PGPUV, PGP3A, PGP3B, PGP2,&
                    & PGP_RDLY, PGPUV_RDLY, PGP3A_RDLY, PGP3B_RDLY, PGP2_RDLY,&
                    & PGLAT, PGLAT_RDLY)
