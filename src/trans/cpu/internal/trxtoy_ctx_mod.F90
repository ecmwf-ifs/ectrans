...
SUBROUTINE INIT_TOG_PACKING_VARS(YDCTX,YDTOGLVARS, INRS, ISETV, KVSET, NGPBLKS,KF_GP, ISETW, IPOSPLUS, IFLDA,IJPOS, PCOMBUFS)
  USE PARKIND1  ,ONLY : JPIM, JPRB
  ...
  INTEGER(KIND=JPIM), INTENT(OUT) :: IPOSPLUS(:)
  INTEGER(KIND=JPIM), INTENT(OUT) :: IFLDA(:,:)
  INTEGER(KIND=JPIM), INTENT(OUT) :: IJPOS(:,:)
