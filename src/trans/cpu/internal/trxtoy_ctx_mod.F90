...
SUBROUTINE INIT_TOG_PACKING_VARS(YDCTX,YDTOGLVARS, INRS, ISETV, KVSET, KF_GP, PCOMBUFS)
  USE PARKIND1  ,ONLY : JPIM, JPRB
  USE TPM_TRANS       ,ONLY : NGPBLKS
...
SUBROUTINE COPY_ZCOMBUF(YDCTX, YDTOGLVARS, INRS,&
  ...
  ASSOCIATE (KSENDCOUNT=>YDCTX%ISENDCOUNT, KRECVCOUNT=>YDCTX%IRECVCOUNT, KNSEND=>YDCTX%INSEND, KNRECV=>YDCTX%INRECV, &
          ...
          & IFLDA=>YDCTX%IFLDA,IPOSPLUS=>YDCTX%IPOSPLUS, JPOS=>YDCTX%IJPOS, ISETW=>YDCTX%ISETW)
...
SUBROUTINE COPY_PGLAT(YDCTX, YDTOGLVARS, LLPGPONLY, LLINDER,&                    
                    & PGP, PGPUV, PGP3A, PGP3B, PGP2,&
                    & PGP_RDLY, PGPUV_RDLY, PGP3A_RDLY, PGP3B_RDLY, PGP2_RDLY,&
                    & PGLAT, PGLAT_RDLY)
  ...
  ASSOCIATE (KSENDCOUNT=>YDCTX%ISENDCOUNT, KRECVCOUNT=>YDCTX%IRECVCOUNT, KNSEND=>YDCTX%INSEND, KNRECV=>YDCTX%INRECV, &
          & KSENDTOT=>YDCTX%ISENDTOT, KRECVTOT=>YDCTX%IRECVTOT, KSEND=>YDCTX%ISEND, KRECV=>YDCTX%IRECV, KINDEX=>YDCTX%IINDEX, &
          & KNDOFF=>YDCTX%INDOFF, KGPTRSEND =>YDCTX%IGPTRSEND,LSEND=>YDCTX%LSEND,IFLDS=>YDCTX%IFLDS)
