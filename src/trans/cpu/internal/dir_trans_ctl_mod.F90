...
IF (NPROMATR > 0 .AND. KF_GP > NPROMATR) THEN
  ...
  CALL ACTIVATE(JBLK, KF_GP, KF_SCALARS_G, KF_UV_G, KVSETUV, KVSETSC, PGP, PSPVOR, PSPDIV, PSPSCALAR)
...
SUBROUTINE ACTIVATE(N, KF_GP, KF_SCALARS_G, KF_UV_G, KVSETUV, KVSETSC, PGP, PSPVOR, PSPDIV, PSPSCALAR)
  INTEGER, INTENT(IN)                         :: N
  INTEGER(KIND=JPIM), INTENT(IN)              :: KF_GP
  INTEGER(KIND=JPIM), INTENT(IN)              :: KF_SCALARS_G
  INTEGER(KIND=JPIM), INTENT(IN)              :: KF_UV_G
