...
SUBROUTINE TRGL_INIT_VARS(YDTOGLVARS, KF_SCALARS_G, &
...
SUBROUTINE TRGL_INIT_OFF_VARS(YDCTX,YDTOGLVARS,KVSET,KPTRGP,KF_GP)
...
SUBROUTINE TGRL_INIT_PACKING_VARS(LSEND, YDCTX,YDTOGLVARS, KVSET, KF_GP, PCOMBUFS)
  USE PARKIND1  ,ONLY : JPIM, JPRB
  USE TPM_TRANS       ,ONLY : NGPBLKS
...
SUBROUTINE TGRL_COPY_ZCOMBUF(YDCTX, YDTOGLVARS, INRS,&
                      & ZCOMBUF, &
                      & KPTRGP,&
                      & PGP, PGPUV, PGP3A, PGP3B, PGP2)                      
...
SUBROUTINE TGRL_COPY_PGLAT(PGLAT, YDCTX, YDTOGLVARS, &
                    & PGP, PGPUV, PGP3A, PGP3B, PGP2)
