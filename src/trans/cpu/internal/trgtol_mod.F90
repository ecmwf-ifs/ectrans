...
!*       0.    Some initializations
!              --------------------
ASSOCIATE(KNSEND=>YDCTX%INSEND, KNRECV=>YDCTX%INRECV, KSENDTOT=>YDCTX%ISENDTOT, &
  &       KRECVTOT=>YDCTX%IRECVTOT, KSEND=>YDCTX%ISEND, KRECV=>YDCTX%IRECV, KINDEX=>YDCTX%IINDEX, &
  &       KNDOFF=>YDCTX%INDOFF)
...
CALL GSTATS(1805,0)
YDCTX%LLINDER = PRESENT(KPTRGP)
YDCTX%LLPGPONLY = PRESENT(PGP)
