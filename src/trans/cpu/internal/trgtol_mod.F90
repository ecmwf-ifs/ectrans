...
INTEGER(KIND=JPIM) :: ISEND, ITAG, JFLD, JL, IFLDS, INS, INR, JNR
INTEGER(KIND=JPIM) :: IPOS,IFLD
...
DO INS=1,KNSEND
  ...
  CALL INIT_TOG_PACKING_VARS(YDCTX,YDTOGLVARS, INS, ISETV, KVSET, NGPBLKS,KF_GP,  ISETW, IPOSPLUS, IFLDA,IJPOS)
