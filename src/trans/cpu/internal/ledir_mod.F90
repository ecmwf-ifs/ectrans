    ...
    ELSE
      ...
      ELSE
        BLOCK
          ...
          ZB_D = PACK_FOR_GEMM_JPRD(ISKIP, KFC, KIFC, KDGLU, KSL, PAIA, PW)
    ...
    ELSE
      ...
      ELSE
        BLOCK
          ...
          ZB_D = PACK_FOR_GEMM_JPRD(ISKIP, KFC, KIFC, KDGLU, KSL, PSIA, PW)
...
FUNCTION PACK_FOR_GEMM_JPRD(KSKIP, KFC, KIFC, KDGLU, KSL, PIN, PW) RESULT(POUT)
...
REAL(KIND=JPRB), INTENT(IN) :: PIN(:, :)
REAL(KIND=JPRD), INTENT(IN) :: PW(:)
REAL(KIND=JPRD) :: POUT(KDGLU, KIFC)
...
END FUNCTION PACK_FOR_GEMM_JPRD
