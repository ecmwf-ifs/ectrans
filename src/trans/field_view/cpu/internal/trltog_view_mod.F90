...
SUBROUTINE TRLTOG_VIEW(PGLAT, KF_FS, KF_GP, KVSET, YDGP)
...
CALL TRLTOG_VIEW_COMM(PGLAT, KF_FS, KF_GP, KVSET, YDGP, YDBUFS)
...
SUBROUTINE TRLTOG_VIEW_COMM(PGLAT, KF_FS, KF_GP, KVSET, YDGP,YDBUFS)
