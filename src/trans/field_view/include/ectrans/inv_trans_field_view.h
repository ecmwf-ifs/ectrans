...
TYPE(FIELD_VIEW),   INTENT(IN) :: YDGPSCALAR(:)
TYPE(FIELD_VIEW),   INTENT(IN) :: YDGPU(:), YDGPV(:)
TYPE(FIELD_VIEW),   INTENT(IN) :: YDGPVOR(:), YDGPDIV(:)

TYPE(FIELD_VIEW),   INTENT(IN) :: YDGPSCALAR_NS(:), YDGPSCALAR_EW(:)
TYPE(FIELD_VIEW),   INTENT(IN) :: YDGPU_EW(:), YDGPV_EW(:)
