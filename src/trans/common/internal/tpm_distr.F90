...
INTEGER(KIND=JPIB), ALLOCATABLE :: OFFSETS_GEMM1(:)
INTEGER(KIND=JPIB), ALLOCATABLE :: OFFSETS_LEINV_IN(:)
INTEGER(KIND=JPIB), ALLOCATABLE :: OFFSETS_LEDIR_OUT(:)
INTEGER(KIND=JPIB), ALLOCATABLE :: OFFSETS_LEINV_LEGPOL(:)
INTEGER(KIND=JPIB), ALLOCATABLE :: OFFSETS_LEDIR_LEGPOL(:)
