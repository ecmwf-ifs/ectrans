...
TYPE DIM_TYPE
  ...
  ! NLEI1 is for inverse Legendre transform work arrays.
  ! NSMAX is the truncation, so we have NSMAX + 1 "normal" values.
  ! 2 more values are required for derivatives to be calculated using spectral central differencing.
  ! 1 more value is required "on the top" for reason I'm not sure of.
