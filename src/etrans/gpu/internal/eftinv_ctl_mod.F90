...
!!! FIXME !!! USE FOURIER_IN_MOD  ,ONLY : FOURIER_IN
USE EFSC_MOD        ,ONLY : EFSC
USE FTINV_MOD       ,ONLY : FTINV
!!! FIXME !!! USE TRLTOG_MOD      ,ONLY : TRLTOG
...
DO JGL=1,D%NDGL_FS
  IGL = JGL
!!! FIXME !!!   CALL FOURIER_IN(ZGTF,KF_OUT_LT,IGL)
...
!   3.  Fourier transform
!!! FIXME !!!   IF(KF_FS > 0) THEN
!!! FIXME !!!     CALL FTINV(ZGTF,KF_FS,IGL)
!!! FIXME !!!   ENDIF
CALL ABORT('FIXME')
...
CALL GSTATS(157,0)
!!! FIXME !!! CALL TRLTOG(ZGTF,KF_FS,KF_GP,KF_SCALARS_G,IVSET,KPTRGP,&
