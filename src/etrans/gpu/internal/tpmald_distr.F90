...
INTEGER(KIND=JPIM) ,ALLOCATABLE :: DALD_NESM0(:)  ! Address in a spectral array of (m, n=m)
INTEGER(KIND=JPIM) ,ALLOCATABLE :: DALD_NCPL2M(:) ! Number of complex Laplace coefficient for m given
INTEGER(KIND=JPIM) ,ALLOCATABLE :: DALD_NPME(:)   ! Address for the Laplace operator and its inverse
