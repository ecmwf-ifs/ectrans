      ...
      DO JK=1,YD_STRUCT%SLEV(JL)%IK
        ...
        IF(JL == 0) THEN
          ...
          IF(IN>0) THEN
            ...
            ELSE             
              CALL FPEOFF_SGEMM('T','N',IN,KF,IM,1.0_JPRB,&
        ...
        ELSE
          IF(JL == ILEVS) THEN
            ...
            ELSE
              CALL FPEOFF_SGEMM('T','N',IRANK,KF,IROWS,1.0_JPRB,&
          ...
          IF(YNODE%ICOLS > IRANK) THEN
            IF (LLDOUBLE) THEN
              CALL DGEMM('N','N',IRANK,KF,IN,1.0_JPRD,&
               ...
               & ZBETA(IBTST,1,IBETALV),ILBETA)
            ELSE
              CALL FPEOFF_SGEMM('N','N',IRANK,KF,IN,1.0_JPRB,&
        ...
        IF(JL == ILEVS) THEN
          ...
          IF (LLDOUBLE) THEN
            CALL DGEMM('N','N',IROWS,KF,YNODE%IRANK,1.0_JPRD,&
             ...
             & PVECOUT(IFR,1),IROUT)
          ELSE
            CALL FPEOFF_SGEMM('N','N',IROWS,KF,YNODE%IRANK,1.0_JPRB,&
