...
USE EC_PARKIND, ONLY: JPRM, JPRD, JPIM
...
CALL INV_TRANS_SP(PSPSCALAR=SPECTRAL_FIELD_SP, PGP=GRID_POINT_FIELD_SP, KRESOL=IRESOL_SP)
CALL INV_TRANS_DP(PSPSCALAR=SPECTRAL_FIELD_DP, PGP=GRID_POINT_FIELD_DP, KRESOL=IRESOL_DP)
