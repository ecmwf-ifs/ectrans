...
INTEGER FUNCTION ECTRANS_TEST_TRANS_API_GPNORM_TRANS_MIN() RESULT(RET) BIND(C)
...
END FUNCTION ECTRANS_TEST_TRANS_API_GPNORM_TRANS_MIN

!---------------------------------------------------------------------------------------------------

! Test GPNORM_TRANS maximum functionality
INTEGER FUNCTION ECTRANS_TEST_TRANS_API_GPNORM_TRANS_MAX() RESULT(RET) BIND(C)
  REAL(KIND=JPRB), ALLOCATABLE :: ZGP(:,:,:)
  REAL(KIND=JPRB) :: ZAVE(1), ZMIN(1), ZMAX(1)
  INTEGER(KIND=JPIM) :: NSPEC2, NGPTOTG, NGPTOT, MY_PROC, NGPBLKS
  LOGICAL :: LUSE_MPI
  ...
  DEALLOCATE(ZGP)
  CALL CLEANUP_TEST(LUSE_MPI)
END FUNCTION ECTRANS_TEST_TRANS_API_GPNORM_TRANS_MAX

!---------------------------------------------------------------------------------------------------

! Test GPNORM_TRANS average functionality
INTEGER FUNCTION ECTRANS_TEST_TRANS_API_GPNORM_TRANS_AVE() RESULT(RET) BIND(C)
  REAL(KIND=JPRB), ALLOCATABLE :: ZGP(:,:,:)
  REAL(KIND=JPRB) :: ZAVE(1), ZMIN(1), ZMAX(1)
  INTEGER(KIND=JPIM) :: NSPEC2, NGPTOTG, NGPTOT, MY_PROC, NGPBLKS
  LOGICAL :: LUSE_MPI
